...
const DEFAULT_SETTINGS: Settings = {
  ...
  stat1Value: '10000+', stat1LabelEn: 'Families Supported', stat1LabelAr: 'عائلة تم دعمها', stat1DescEn: 'across cultures & generations', stat1DescAr: 'عبرَ الثّقافات والأجيال',
