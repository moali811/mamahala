    ...
    return (
      <div className={`relative ${className}`}>
        <input
          ...
          id={id}
          className={`
            peer w-full px-4 pt-6 pb-2 rounded-xl border bg-white text-[#1E1E2A]
            transition-all duration-200 outline-none
            placeholder-transparent
            ${error
              ? 'border-[#C45B5B] focus:border-[#C45B5B] focus:ring-2 focus:ring-[#C45B5B]/20'
              : 'border-[#F3EFE8] focus:border-[#2B5F4E] focus:ring-2 focus:ring-[#2B5F4E]/10 hover:border-[#2B5F4E]/30'
            }
          `}
          placeholder={label}
        ...
        <label
          ...
          className={`
            ...
            ${isActive
              ? 'top-2 text-xs font-medium text-[#2B5F4E]'
