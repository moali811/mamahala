...
const DEFAULT_FAQS: Record<string, { q: string; qAr: string; a: string; aAr: string }[]> = {
  youth: [
    ...
    { q: `Will my teen think I'm punishing them by sending them to counseling?`, qAr: 'هل سيعتقد مراهقي أنني أعاقبه بإرساله للاستشارة؟', a: `This is one of the most common worries parents have. We frame sessions as a "support space," not a punishment. Many teens actually end up looking forward to their sessions because it's the one place where someone listens without judgment or agenda.`, aAr: 'هذا من أكثر المخاوف شيوعاً لدى الوالدين. نُصيغ الجلسات على أنها "مساحة دعم" وليست عقوبة. كثير من المراهقين يتطلعون لجلساتهم لأنها المكان الوحيد الذي يستمع فيه شخص دون حكم.' },
  ],
  families: [
    ...
    { q: `What if my partner doesn't want to come?`, qAr: 'ماذا لو لم يرغب شريكي في الحضور؟', a: `That's okay — and more common than you think. You can start alone, and often when one person starts making changes, the whole family dynamic shifts. We can guide you on how to create positive change even if you're the only one in the room.`, aAr: 'لا بأس — وهذا أكثر شيوعاً مما تعتقد. يمكنك البدء وحدك، وغالباً عندما يبدأ شخص واحد بالتغيير، تتغير ديناميكية الأسرة بأكملها.' },
  ...
  adults: [
    ...
    { q: `I've tried therapy before and it didn't help. What's different here?`, qAr: 'جربت العلاج من قبل ولم يساعد. ما المختلف هنا؟', a: `Not every counselor is the right fit. We combine evidence-based approaches with deep cultural sensitivity. Many clients who've had lukewarm experiences elsewhere find that the warmth and personalization here makes all the difference.`, aAr: 'ليس كل مستشار هو الخيار الصحيح. نجمع بين الأساليب المبنية على الأدلة والحساسية الثقافية العميقة.' },
  ...
  couples: [
    ...
    { q: `What if one of us isn't comfortable opening up in front of the other?`, qAr: 'ماذا لو كان أحدنا غير مرتاح للانفتاح أمام الآخر؟', a: `Completely normal. We create a structured, safe environment where both partners feel heard. We may even suggest individual sessions alongside couples work. The goal isn't to expose anyone; it's to build a bridge between you.`, aAr: 'طبيعي تماماً. نخلق بيئة منظمة وآمنة حيث يشعر كلا الشريكين بأنه مسموع.' },
    { q: `We argue about the same things over and over. Can counseling actually change that?`, qAr: 'نتشاجر حول نفس الأشياء مراراً. هل يمكن للاستشارة تغيير ذلك فعلاً؟', a: `Yes — because recurring arguments aren't about the topic. They're about unmet needs underneath. We help you decode what's really happening beneath the surface so you can break the cycle.`, aAr: 'نعم — لأن الخلافات المتكررة ليست عن الموضوع نفسه. إنها عن احتياجات غير ملباة تحتها.' },
  ],
  experiential: [
