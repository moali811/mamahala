      ...
      await resend.emails.send({
        ...
        html: emailWrapper(`
          <div style="${emailStyles.card}">
            <h1 style="${emailStyles.heading}">${levelNumber != null ? `Level ${levelNumber} Unlocked!` : 'Module Unlocked!'}</h1>
            <p style="${emailStyles.text}">Your payment has been confirmed. ${levelNumber != null ? `All modules in Level ${levelNumber}` : 'Your next module'} are now unlocked and ready for you.</p>
