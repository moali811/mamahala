...
const serviceNames: Record<string, { en: string; ar: string }> = {
  'family-relationship-strengthening': { en: 'Family Relationship Strengthening', ar: 'تقوية العلاقات الأسرية' },
  'parenting-coaching': { en: 'Parenting Coaching', ar: 'توجيه الأبوة والأمومة' },
  'under-18-counseling': { en: 'Under 18 Counseling', ar: 'استشارة لمن هم أقل من 18' },
  'tackling-child-tantrums': { en: 'Tackling Child Tantrums', ar: 'التعامل مع نوبات غضب الأطفال' },
  'lifestyle-coaching': { en: 'Lifestyle Coaching', ar: 'توجيه نمط الحياة' },
  'self-development-coaching': { en: 'Self-Development Coaching', ar: 'توجيه التطوير الذاتي' },
};
...
export default function FamilyHarmonyQuizPage() {
    ...
    <div className="bg-[#FAF7F2] min-h-screen">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#E8C4C0] via-[#F0D5CA] to-[#FAF0EC]">
        ...
        <div className="container-main relative pt-24 pb-28 md:pt-28 md:pb-32 text-center">
          <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }}>
            <Breadcrumb
              ...
              items={[
                ...
                { label: isRTL ? 'تقييم الانسجام الأسري' : 'Family Harmony Assessment' },
              ]}
            />
          </motion.div>
          <motion.div
          ...
          >
            <Users className="w-8 h-8 text-[#7A3B5E]" />
          </motion.div>
          <motion.h1
          ...
          >
            {isRTL ? (
              <>
                تقييم <span className="text-[#7A3B5E] italic">الانسجام</span> الأسري
              </>
            ) : (
              <>
                Family <span className="text-[#7A3B5E] italic">Harmony</span> Assessment
              </>
            )}
          </motion.h1>
          <motion.p
          ...
          >
            {isRTL
              ? 'اكتشف نقاط القوة في عائلتك والمجالات التي يمكن أن تزدهر فيها. 12 سؤالاً فقط - حوالي 5 دقائق.'
              : 'Discover your family\u2019s strengths and the areas where you can thrive. Just 12 questions \u2014 about 5 minutes.'}
          </motion.p>
        </div>
                ...
                <ScrollReveal>
                  <div className="bg-white rounded-3xl p-10 border border-[#F3EFE8] shadow-sm">
                    ...
                    <p className="text-[#6B6580] leading-relaxed mb-4">
                      {isRTL
                        ? 'سنطرح عليك 12 سؤالاً تغطي أربعة أبعاد رئيسية لصحة عائلتك: التواصل، والأمان العاطفي، والحدود الصحية، والرابطة الأسرية.'
                        : "We\u2019ll ask you 12 questions across four key dimensions of your family\u2019s health: Communication, Emotional Safety, Healthy Boundaries, and Family Connection."}
                    </p>
                    <p className="text-[#8E8E9F] text-sm leading-relaxed mb-8">
                      {isRTL
                        ? 'لا توجد إجابات صحيحة أو خاطئة \u2014 فقط كن صادقاً مع نفسك. نتائجك خاصة تماماً.'
                        : 'There are no right or wrong answers \u2014 just be honest with yourself. Your results are completely private.'}
                    </p>
                    <Button
                      size="lg"
                ...
                <ScrollReveal>
                  <div className="bg-white rounded-3xl p-10 lg:p-14 border border-[#F3EFE8] shadow-[0_20px_60px_rgba(0,0,0,0.06)] text-center">
                    ...
                    <p className="text-sm font-medium text-[#8E8E9F] uppercase tracking-wider mb-6">
                      {isRTL ? 'نتيجة الانسجام الأسري' : 'Your Family Harmony Score'}
                    </p>
                    ...
                    <div className="text-start space-y-5 mb-10">
                      <h3
                        ...
                        style={{ fontFamily: 'var(--font-heading)' }}
                      >
                        {isRTL ? 'تحليل الأبعاد' : 'Dimension Breakdown'}
                      </h3>
                      {dimensions.map((dim) => {
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 justify-center">
                      ...
                      >
                        {isRTL ? 'ابدأ محادثة مجانية' : 'Start a Free Conversation'}
                      </Button>
                      <Button
                        as="a"
                        ...
                        iconPosition="right"
                      >
                        {isRTL ? 'تصفح الخدمات' : 'Explore Services'}
                      </Button>
                    </div>
                    ...
                    <div className="mt-8 p-5 bg-[#FAF7F2] rounded-xl border border-[#F3EFE8] text-xs text-[#8E8E9F] leading-relaxed">
                      ...
                      <p>
                        {isRTL
                          ? 'مبنيٌّ على أبحاثٍ قائمةٍ على الأدلّةِ في مجالِ نظريّةِ الأنظمةِ الأسريّةِ وعلمِ النفسِ التنمويّ. للحصولِ على تقييمٍ شاملٍ ومُخصَّص، نوصي بحجزِ جلسةٍ مع مستشارٍ مؤهَّل.'
                          : 'Informed by evidence-based research in family systems theory and developmental psychology. For a comprehensive, personalized evaluation, we recommend booking a session with a qualified counselor.'}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4 mt-8">
                      ...
                      <button
                          ...
                          try {
                            await fetch('/api/quiz-share', {
                              ...
                              body: JSON.stringify({
                                name: 'Anonymous',
                                email: '',
                                quizSlug: 'family-harmony',
                                quizName: isRTL ? 'تقييم الانسجام الأسري' : 'Family Harmony Assessment',
                                sessionId,
                                score: totalScore,
                                maxScore: 60,
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#7A3B5E] text-white text-sm font-medium hover:bg-[#5E2D48] transition-colors"
                      >
                      ...
                      <button
                        ...
                        className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#C8A97D]/15 text-sm font-medium text-[#7A3B5E] hover:bg-[#C8A97D]/25 transition-colors"
                      >
