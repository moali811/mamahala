...
export const events: SmartEvent[] = [
...

  {
    ...
    locationNameEn: 'Community Center, Ottawa',
    locationNameAr: 'المركز المجتمعي، أوتاوا',
...

  {
    ...
    locationType: 'hybrid',
    locationNameEn: 'Google Meet + Ottawa Community Center',
    locationNameAr: 'Google Meet + المركز المجتمعي في أوتاوا',
    locationAddress: 'Ottawa, ON, Canada',
    isFree: false,
    priceCAD: 120,
...

  {
    ...
    timezone: 'America/Toronto',
    locationType: 'in-person',
    locationNameEn: 'Gatineau Park, Ottawa',
    locationNameAr: 'حديقة غاتينو، أوتاوا',
    locationAddress: 'Gatineau Park, QC, Canada',
    isFree: false,
    priceCAD: 35,
  ...
  /* ── Past Event ─────────────────────────────────────────────── */
  {
    ...
    timezone: 'America/Toronto',
    locationType: 'in-person',
    locationNameEn: 'Global Family Center',
    locationNameAr: 'مركز الأسرة العالمي',
    locationAddress: 'Ottawa, ON, Canada',
    isFree: false,
    priceCAD: 25,
