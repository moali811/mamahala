...
export const events: SmartEvent[] = [
  /* ── Summer 2026 Flagship Programs — Premium Featured ──────── */
  {
    ...
    formatDescEn: '4-week hybrid program — 3 online sessions (90 min each) + 1 full-day in-person retreat in Ottawa. Small circle of 10.',
    formatDescAr: 'بَرْنامَجٌ هَجينٌ مِنْ ٤ أَسابيع — ٣ جَلَساتٍ عَبْرَ الإِنْتَرْنِتْ (٩٠ دَقيقَةً لِكُلٍّ مِنْها) + يَوْمٌ كامِلٌ في اعْتِكافٍ حُضورِيٍّ في أوتاوا. دائِرَةٌ صَغيرَةٌ مِنْ ١٠ فَتَيات.',
...

  {
    ...
    feeDisplayEn: '$149 CAD · 4-week program with lifetime recording access',
    feeDisplayAr: '١٤٩ دولار كَنَدي · بَرْنامَجٌ مِنْ ٤ أَسابيعَ مع وُصولٍ دائِمٍ لِلتَّسْجيلات',
    formatDescEn: '4-week hybrid program — 3 online sessions (90 min each) + 1 full-day in-person gathering in Ottawa. Brotherhood of 10.',
    formatDescAr: 'بَرْنامَجٌ هَجينٌ مِنْ ٤ أَسابيع — ٣ جَلَساتٍ عَبْرَ الإِنْتَرْنِتْ (٩٠ دَقيقَةً لِكُلٍّ مِنْها) + يَوْمٌ كامِلٌ حُضورِيٌّ في أوتاوا. أُخُوَّةٌ مِنْ ١٠ فِتْيان.',
