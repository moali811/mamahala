...
الهدف ليس أن تصبح بلا مشاعر أو أن تتحكّم في كل استجابة. بل أن توسّع نطاقك — أن يكون لديك خيارات أكثر في كيفية استجابتك بدلًا من أن تعمل على الطيار الآلي. حين تفهم أنماطك، تكتسب حرية التصرّف بقصد بدلًا من ردّ الفعل. وهذه بداية الذكاء العاطفي الحقيقي.`,
          ...
          blocks: [
            ...
            { kind: 'framework', id: 'ep-loop', diagram: { type: 'flowchart', titleEn: 'The Emotion Loop', titleAr: 'دَوّامَةُ الشُّعور', nodes: [ { id: 'trigger', labelEn: 'Trigger', labelAr: 'مُحَفِّز', descriptionEn: 'The event or moment', descriptionAr: 'الحَدَث', color: '#C4636A', position: { x: 50, y: 5 } }, { id: 'thought', labelEn: 'Thought', labelAr: 'فِكْرَة', descriptionEn: 'Often automatic, often distorted', descriptionAr: 'غالِباً تِلْقائيَّة', color: '#D4A84B', position: { x: 50, y: 25 } }, { id: 'feeling', labelEn: 'Feeling', labelAr: 'شُعور', descriptionEn: 'Physical + emotional', descriptionAr: 'جَسَدِيّ + عاطِفيّ', color: '#5B8FA8', position: { x: 50, y: 50 } }, { id: 'behavior', labelEn: 'Behavior', labelAr: 'سُلوك', descriptionEn: 'What you do next', descriptionAr: 'ما تَفْعَلينَهُ تالياً', color: '#3B8A6E', position: { x: 50, y: 75 } }, { id: 'result', labelEn: 'Result', labelAr: 'نَتيجَة', descriptionEn: 'Reinforces or challenges the pattern', descriptionAr: 'تُقَوّي أَوْ تَتَحَدّى النَّمَط', color: '#7A3B5E', position: { x: 50, y: 95 } } ], connections: [ { from: 'trigger', to: 'thought' }, { from: 'thought', to: 'feeling' }, { from: 'feeling', to: 'behavior' }, { from: 'behavior', to: 'result' } ] } },
