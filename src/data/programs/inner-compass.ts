          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Partial Alignment', labelAr: 'توافق جزئي', feedbackEn: 'You have some alignment but there are areas where your authentic self is not fully expressed. Explore which areas feel most in tension.', feedbackAr: 'لديك بعض التوافق لكن هناك مجالات لا يتم فيها التعبير عن ذاتك الأصيلة بالكامل. استكشف أي المجالات تشعر فيها بأكبر قدر من التوتر.' },
                { min: 5, max: 5, labelEn: 'Strong Alignment', labelAr: 'توافق قوي', feedbackEn: 'You are living with significant congruence. Continue deepening your self-awareness and honoring your evolving identity.', feedbackAr: 'أنت تعيش بتوافق كبير. استمر في تعميق وعيك الذاتي واحترام هويتك المتطوّرة.' },
              ],
            },
          ],
          frameworkDiagrams: [
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Growing Insight', labelAr: 'بصيرة متنامية', feedbackEn: 'You are building the capacity to distinguish past echoes from present reality. Continue practicing the pause between trigger and response.', feedbackAr: 'أنت تبني القدرة على التمييز بين أصداء الماضي وواقع الحاضر. استمر في ممارسة الوقفة بين المحفّز والاستجابة.' },
                { min: 5, max: 5, labelEn: 'Strong Pattern Recognition', labelAr: 'تعرّف قوي على الأنماط', feedbackEn: 'You have developed strong self-awareness. Focus now on choosing new responses when old patterns activate.', feedbackAr: 'لقد طوّرت وعيًا ذاتيًا قويًا. ركّز الآن على اختيار استجابات جديدة حين تنشط الأنماط القديمة.' },
              ],
            },
          ],
          frameworkDiagrams: [
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Active Inner Critic', labelAr: 'ناقد داخلي نشط', feedbackEn: 'Your inner critic is a strong presence. The Self-Compassion Break practice can help you interrupt this pattern and build a kinder inner voice.', feedbackAr: 'ناقدك الداخلي حضوره قوي. ممارسة استراحة التعاطف مع الذات يمكن أن تساعدك على مقاطعة هذا النمط وبناء صوت داخلي أكثر لطفًا.' },
                { min: 5, max: 5, labelEn: 'Dominant Inner Critic', labelAr: 'ناقد داخلي مهيمن', feedbackEn: 'Self-criticism is your default mode. This module\'s practices can create significant positive change for you, but be patient — rewiring decades of self-criticism takes time.', feedbackAr: 'النقد الذاتي هو وضعك الافتراضي. ممارسات هذا الدرس يمكن أن تُحدث تغييرًا إيجابيًا كبيرًا لك، لكن تحلَّ بالصبر — إعادة برمجة عقود من النقد الذاتي تستغرق وقتًا.' },
              ],
            },
          ],
        },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Emerging Permission', labelAr: 'إذن ناشئ', feedbackEn: 'You are learning to honor loss alongside change. Continue building this capacity — it accelerates healthy transitions.', feedbackAr: 'أنت تتعلم احترام الفقدان إلى جانب التغيير. واصل بناء هذه القدرة — فهي تسرّع التحولات الصحية.' },
                { min: 5, max: 5, labelEn: 'Healthy Grief Processing', labelAr: 'معالجة حزن صحية', feedbackEn: 'You navigate transitions with emotional honesty. This capacity serves you well through all of life\'s changes.', feedbackAr: 'أنت تتعامل مع التحولات بصدق عاطفي. هذه القدرة تخدمك جيدًا عبر جميع تغيّرات الحياة.' },
              ],
            },
          ],
          frameworkDiagrams: [
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Mixed Mindset', labelAr: 'عقلية مختلطة', feedbackEn: 'You see both sides of stress. Strengthening your stress-enhancing mindset may improve both your health and performance.', feedbackAr: 'أنت ترى جانبي الضغط. تعزيز عقلية الضغط المعزّز قد يحسّن صحتك وأداءك معًا.' },
                { min: 5, max: 5, labelEn: 'Stress-is-Enhancing Mindset', labelAr: 'عقلية الضغط معزّز', feedbackEn: 'You view stress as a challenge response. This mindset is associated with better health outcomes and performance under pressure.', feedbackAr: 'أنت ترى الضغط كاستجابة تحدٍّ. هذه العقلية ترتبط بنتائج صحية أفضل وأداء أفضل تحت الضغط.' },
              ],
            },
          ],
          frameworkDiagrams: [
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Developing Boundaries', labelAr: 'حدود قيد التطوير', feedbackEn: 'You can set boundaries in some situations but struggle in others. Identify where boundaries are hardest and practice specifically in those areas.', feedbackAr: 'يمكنك وضع حدود في بعض المواقف لكنك تعاني في أخرى. حدّد أين تكون الحدود أصعب ومارس تحديدًا في تلك المجالات.' },
                { min: 5, max: 5, labelEn: 'Strong Boundaries', labelAr: 'حدود قوية', feedbackEn: 'You are comfortable setting limits. This is a significant strength for your emotional health and relationships.', feedbackAr: 'أنت مرتاح في وضع الحدود. هذه قوة كبيرة لصحتك العاطفية وعلاقاتك.' },
              ],
            },
          ],
        },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Emerging Clarity', labelAr: 'وضوح ناشئ', feedbackEn: 'You have some sense of direction but it is not yet fully defined. Continue experimenting and reflecting — purpose often crystallizes gradually.', feedbackAr: 'وضوح ناشئ' },
                { min: 5, max: 5, labelEn: 'Clear Purpose', labelAr: 'هدف واضح', feedbackEn: 'You have a strong sense of direction. This module can help you deepen and expand your purpose, and navigate any future evolutions.', feedbackAr: 'هدف واضح' },
              ],
            },
          ],
          frameworkDiagrams: [
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Mixed Quality', labelAr: 'جودة مختلطة', feedbackEn: 'Some relationships nourish you while others deplete you. Be intentional about investing more in the nourishing ones.', feedbackAr: 'بعض العلاقات تغذيك بينما أخرى تستنزفك. كن واعيًا في استثمار المزيد في العلاقات المغذية.' },
                { min: 5, max: 5, labelEn: 'Nourishing Network', labelAr: 'شبكة مغذية', feedbackEn: 'You have built a support system that energizes you. This is one of the strongest foundations for long-term health and happiness.', feedbackAr: 'لقد بنيت نظام دعم يمنحك الطاقة. هذا أحد أقوى الأسس للصحة والسعادة على المدى الطويل.' },
              ],
            },
          ],
        },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 3, max: 4, labelEn: 'Developing Resilience', labelAr: 'تطوير المرونة', feedbackEn: 'You recover from setbacks but it takes effort. Strengthening your weakest resilience foundation will have the biggest impact.', feedbackAr: 'أنت تتعافى من الانتكاسات لكن ذلك يتطلب جهدًا. تعزيز أضعف أساس من أسس مرونتك سيكون له الأثر الأكبر.' },
                { min: 5, max: 5, labelEn: 'Strong Resilience', labelAr: 'مرونة قوية', feedbackEn: 'You have built solid resilience capacity. Continue maintaining your foundations and use challenges as opportunities to deepen these skills.', feedbackAr: 'لقد بنيت قدرة مرونة صلبة. استمر في الحفاظ على أسسك واستخدم التحديات كفرص لتعميق هذه المهارات.' },
              ],
            },
          ],
          frameworkDiagrams: [
