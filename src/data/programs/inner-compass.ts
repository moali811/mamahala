...
الشجاعة لطرح سؤال "من أنا حقًا؟" هي الخطوة الأولى في هذه الرحلة. والحقيقة الجميلة هي: أنت من يقرّر الإجابة.`,
          ...
          blocks: [
            ...
            { kind: 'callout', id: 'wi-intro', variant: 'insight', textEn: 'Answer what\'s TRUE, not what sounds good. The honesty is the whole exercise.', textAr: 'أَجيبي بِالصَّحيح، لا بِما يَبْدو جَميلاً. الصِّدْقُ هو التَّمْرينُ كُلُّه.' },
            { kind: 'likert', id: 'wi-lk1', reflection: { titleEn: 'Known to Yourself', titleAr: 'مَعْروفَةٌ لِنَفْسِك', statementEn: 'I can name what I actually want — separate from what others expect of me.', statementAr: 'أَسْتَطيعُ تَسْمِيَةَ ما أُريدُهُ فِعْلاً — مُنْفَصِلاً عَمّا يَتَوَقَّعُهُ الآخَرون.', scaleLabels: { lowEn: 'Blurred', lowAr: 'مُبَهَّم', highEn: 'Clear', highAr: 'واضِح' }, interpretations: [ { min: 1, max: 2, labelEn: 'Shaped by others', labelAr: 'مُشَكَّلَةٌ من الآخَرين', feedbackEn: 'You\'ve been answering "what do they want" for so long, your own wants got quiet. Start tiny: what do you want for lunch? What do you want for tomorrow?', feedbackAr: 'تُجيبينَ "ماذا يُريدون" طَويلاً حَتّى هَدَأَتْ رَغَباتُك. اِبْدَئي صَغيرَة: ماذا تُريدينَ لِلغَداء؟ لِلغَد؟' }, { min: 3, max: 5, labelEn: 'Getting clearer', labelAr: 'تَتَّضِح', feedbackEn: 'Awareness forming. Notice when you default to others\' wants.', feedbackAr: 'الوَعْيُ يَتَشَكَّل. لاحِظي مَتى تَعودينَ لِرَغَباتِ الآخَرين.' }, { min: 6, max: 7, labelEn: 'Known self', labelAr: 'ذاتٌ مَعْروفَة', feedbackEn: 'This clarity is rare. Protect it.', feedbackAr: 'هذا الوُضوحُ نادِر. اِحْمِيه.' } ] } },
            { kind: 'likert', id: 'wi-lk2', reflection: { titleEn: 'Aligned Life', titleAr: 'حَياةٌ مُتَوافِقَة', statementEn: 'My daily choices match what I actually value.', statementAr: 'اخْتِياراتي اليَوْميَّةُ تُطابِقُ ما أُقَدِّرُه.', scaleLabels: { lowEn: 'Misaligned', lowAr: 'غَيْرُ مُتَوافِقَة', highEn: 'Aligned', highAr: 'مُتَوافِقَة' }, interpretations: [ { min: 1, max: 2, labelEn: 'Values-action gap', labelAr: 'فَجْوَةٌ بَيْنَ القِيَمِ والفِعْل', feedbackEn: 'That gap is exhausting. Name 1 small action this week that matches a core value.', feedbackAr: 'تِلْكَ الفَجْوَةُ مُرْهِقَة. سَمّي فِعْلاً صَغيراً هذا الأُسْبوعَ يُطابِقُ قيمَةً جَوْهَريَّة.' }, { min: 3, max: 5, labelEn: 'Partially aligned', labelAr: 'مُتَوافِقَةٌ جُزْئيّاً', feedbackEn: 'You move toward your values sometimes. Where do you drift?', feedbackAr: 'تَتَحَرَّكينَ نَحْوَ قِيَمِكِ أَحْياناً. أَيْنَ تَبْتَعِدين؟' }, { min: 6, max: 7, labelEn: 'Integrated', labelAr: 'مُدْمَجَة', feedbackEn: 'You live what you believe. This is hard-won.', feedbackAr: 'تَعيشينَ ما تُؤْمِنين. هذا انْتِصارٌ صَعْب.' } ] } },
            { kind: 'likert', id: 'wi-lk3', reflection: { titleEn: 'Inner Voice', titleAr: 'الصَّوْتُ الدّاخِليّ', statementEn: 'I hear my intuition and trust it.', statementAr: 'أَسْمَعُ حَدْسي وأَثِقُ بِه.', scaleLabels: { lowEn: 'Silenced', lowAr: 'مُسْكَت', highEn: 'Clear', highAr: 'واضِح' }, interpretations: [ { min: 1, max: 2, labelEn: 'Intuition silenced', labelAr: 'حَدْسٌ مُسْكَت', feedbackEn: 'Trauma, criticism, or overthinking can mute intuition. Start listening to body signals: tightness, ease, pulling toward/away.', feedbackAr: 'الصَّدْمَةُ أَوِ النَّقْدُ أَوِ التَّفْكيرُ الزّائِدُ يُسْكِتُ الحَدْس. اِسْتَمِعي لِإشاراتِ الجَسَد.' }, { min: 3, max: 5, labelEn: 'Hearing but doubting', labelAr: 'تَسْمَعينَ لَكِنْ تَشُكّين', feedbackEn: 'You sense it, you question it. Practice trusting small decisions first.', feedbackAr: 'تَشْعُرينَ بِهِ، تَشُكّين. مارِسي الثِّقَةَ في القَراراتِ الصَّغيرَةِ أَوَّلاً.' }, { min: 6, max: 7, labelEn: 'Trusted intuition', labelAr: 'حَدْسٌ مَوْثوق', feedbackEn: 'This is deep inner knowing. Rare.', feedbackAr: 'هذِهِ مَعْرِفَةٌ داخِليَّةٌ عَميقَة. نادِرَة.' } ] } },
            { kind: 'likert', id: 'wi-lk4', reflection: { titleEn: 'Who You Were vs Who You Are', titleAr: 'من كُنْتِ مُقابِلَ من أَنْتِ', statementEn: 'The person I am today matches who I want to become.', statementAr: 'الشَّخْصَةُ الّتي أَنا اليَوْمَ تُطابِقُ من أُريدُ أَنْ أَكون.', scaleLabels: { lowEn: 'Out of sync', lowAr: 'خارِجَ التَّوافُق', highEn: 'On path', highAr: 'على الطَّريق' }, interpretations: [ { min: 1, max: 2, labelEn: 'Off your path', labelAr: 'خارِجَ طَريقِك', feedbackEn: 'The gap between who you are and who you want to become is the growth map. This program is one step closer.', feedbackAr: 'الفَجْوَةُ هي خَريطَةُ النُّمُوّ. هذا البَرْنامَجُ خُطْوَةٌ أَقْرَب.' }, { min: 3, max: 5, labelEn: 'Directionally right', labelAr: 'الاِتِّجاهُ صَحيح', feedbackEn: 'You\'re walking toward her. Keep going.', feedbackAr: 'تَمْشينَ نَحْوَها. واصِلي.' }, { min: 6, max: 7, labelEn: 'Aligned becoming', labelAr: 'تَصَيُّرٌ مُتَوافِق', feedbackEn: 'You\'re becoming who you were meant to be. Beautiful.', feedbackAr: 'تَصيرينَ من كانَ مَقْصوداً أَنْ تَكوني. جَميل.' } ] } },
            { kind: 'callout', id: 'wi-drhala', variant: 'dr-hala', textEn: 'The self you\'re meeting in this assessment isn\'t new. She\'s been waiting. The work of Inner Compass is clearing away everything that covered her — expectations, fears, old stories — until you can hear her again.', textAr: 'الذّاتُ الّتي تَلْتَقينَها في هذا التَّقْييمِ لَيْسَتْ جَديدَة. كانَتْ تَنْتَظِر. عَمَلُ البَوْصَلَةِ الدّاخِليَّةِ هو إزالَةُ ما غَطّاها — التَّوَقُّعات، المَخاوِف، القِصَصُ القَديمَة — حَتّى تَسْمَعينَها ثانِيَة.' },
            { kind: 'reflection-prompt', id: 'wi-refl', minWords: 50, promptEn: 'What\'s ONE thing you know to be true about yourself that you\'ve been afraid to name out loud? Name it here.', promptAr: 'ما شَيْءٌ تَعْرِفينَهُ صَحيحاً عَنْ نَفْسِكِ كُنْتِ خائِفَةً من تَسْمِيَتِهِ؟ سَمّيهِ هُنا.' },
          ],
          learningObjectives: [
          ...
          blocks: [
            ...
            { kind: 'callout', id: 'ua-science', variant: 'insight', textEn: 'Your amygdala (alarm) fires 200ms BEFORE your prefrontal cortex (reasoning) engages. That\'s why anxiety feels physical before it feels thoughtful. You\'re not irrational — you\'re temporarily hijacked.', textAr: 'اللَّوْزَةُ (الإنْذار) تُطْلِقُ 200 جُزْءاً من الثّانيَةِ قَبْلَ القِشْرَةِ الأَمامِيَّةِ (التَّفْكير). لِذا يَشْعُرُ القَلَقُ جَسَدِيّاً قَبْلَ فِكْرِيّاً. لَسْتِ غَيْرَ عاقِلَة — أَنْتِ مَخْطوفَةٌ مُؤَقَّتاً.' },
            {
              ...
              diagram: {
                ...
                nodes: [
                  { id: 'thought', labelEn: 'Anxious Thought', labelAr: 'فِكْرَةٌ قَلِقَة', descriptionEn: '"What if something goes wrong?" — the trigger', descriptionAr: '"ماذا لَوْ سارَ شَيْءٌ خَطَأ؟" — المُحَفِّز', color: '#C4636A', position: { x: 50, y: 10 }, insightEn: 'Notice the "what if" without believing it. Try saying: "There goes my alarm again." Naming the thought loosens its grip.', insightAr: 'لاحِظي "ماذا لَوْ" بِلا تَصْديقِها. جَرِّبي: "ها هو إنْذاري ثانِيَةً." تَسْمِيَةُ الفِكْرَةِ تُرْخي قَبْضَتَها.' },
                  { id: 'body', labelEn: 'Physical Symptoms', labelAr: 'أَعْراضٌ جَسَدِيَّة', descriptionEn: 'Racing heart, tight chest, nausea — amygdala fires', descriptionAr: 'قَلْبٌ مُتَسارِع، صَدْرٌ مَشْدود، غَثَيان — اللَّوْزَةُ تُطْلِق', color: '#D4A84B', position: { x: 90, y: 40 }, insightEn: 'When your body sounds the alarm, try 4-4-6 breathing: inhale 4 counts, hold 4, exhale 6. This tells your nervous system the threat is not real.', insightAr: 'حينَ يُطْلِقُ جَسَدُكِ الإنْذار، جَرِّبي تَنَفُّسَ 4-4-6: شَهيق 4، حَبْس 4، زَفير 6. هذا يُخْبِرُ جِهازَكِ العَصَبِيَّ أَنَّ التَّهْديدَ لَيْسَ حَقيقيّاً.' },
                  { id: 'avoid', labelEn: 'Avoidance', labelAr: 'تَجَنُّب', descriptionEn: 'Cancel, withdraw, stay home — the escape', descriptionAr: 'أَلْغي، اِنْسَحِبي، اِبْقَيْ — الهُروب', color: '#5B8FA8', position: { x: 75, y: 85 }, insightEn: 'Every time you avoid, the world gets a little smaller. Try doing one tiny thing your anxiety tells you to skip this week.', insightAr: 'كُلَّ مَرَّةٍ تَتَجَنَّبين، يَتَقَلَّصُ العالَمُ قَليلاً. جَرِّبي فِعْلَ شَيْءٍ صَغيرٍ يُخْبِرُكِ القَلَقُ بِتَخَطّيهِ هذا الأُسْبوع.' },
            ...
            { kind: 'micro-quiz', id: 'ua-mq1', question: { textEn: 'You\'re lying in bed at 2am spiraling about work. Best first move?', textAr: 'مُسْتَيْقِظَةٌ في السَّريرِ في الـ 2 صَباحاً تَدورينَ حَوْلَ العَمَل. أَفْضَلُ خُطْوَة؟', options: [ { labelEn: 'Think through all the scenarios to solve it', labelAr: 'فَكِّري في كُلِّ السِّينَاريوهات', correct: false, explanationEn: 'Thinking at 2am rarely produces solutions. It produces loops.', explanationAr: 'التَّفْكيرُ في الـ 2 صَباحاً نادِراً ما يُنْتِجُ حُلولاً. يُنْتِجُ دَوّاماتٍ.' }, { labelEn: 'Breathe 4-4-6, then name: "This is my alarm. It\'ll wait till morning."', labelAr: 'تَنَفَّسي 4-4-6، ثُمَّ سَمّي: "هذا إنْذاري. سَيَنْتَظِرُ الصَّباح."', correct: true, explanationEn: 'Yes. Calm the body first. Then command the story.', explanationAr: 'نَعَم. أَهْدِئي الجَسَدَ أَوَّلاً. ثُمَّ تَحَكَّمي في القِصَّة.' }, { labelEn: 'Get up and work on it', labelAr: 'اِنْهَضي واعْمَلي عَلَيْه', correct: false, explanationEn: 'Feeds the alarm. Body thinks the threat is real.', explanationAr: 'يُغَذّي الإنْذار. الجَسَدُ يَظُنُّ التَّهْديدَ حَقيقيّاً.' } ] } },
            { kind: 'callout', id: 'ua-drhala', variant: 'dr-hala', textEn: 'You don\'t have to defeat anxiety. You have to build a different relationship with it — one where you listen to the signal, thank it for showing up, and choose what to do next. Not fighting. Not obeying. Partnership.', textAr: 'لَسْتِ مُضْطَرَّةً لِهَزيمَةِ القَلَق. عَلَيْكِ بِناءُ عَلاقَةٍ مُخْتَلِفَةٍ مَعَه — تَسْتَمِعينَ لِلإشارَة، تَشْكُرينَهُ على الحُضور، وتَخْتارينَ ماذا تَفْعَلينَ تالياً. لا قِتال. لا طاعَة. شَراكَة.' },
            { kind: 'reflection-prompt', id: 'ua-refl', minWords: 40, promptEn: 'What does YOUR anxiety usually show up about? Is it a real signal, a stuck loop, or both? What would "partnership with it" look like this week?', promptAr: 'عَلى ماذا يَظْهَرُ قَلَقُكِ عادَةً؟ إشارَةٌ حَقيقيّة، دَوّامَةٌ عالِقَة، أَمْ كِلاهُما؟ كَيْفَ سَتَبْدو "شَراكَةٌ مَعَه" هذا الأُسْبوع؟' },
          ],
          learningObjectives: [
...
الهدف ليس أن تصبح بلا مشاعر أو أن تتحكّم في كل استجابة. بل أن توسّع نطاقك — أن يكون لديك خيارات أكثر في كيفية استجابتك بدلًا من أن تعمل على الطيار الآلي. حين تفهم أنماطك، تكتسب حرية التصرّف بقصد بدلًا من ردّ الفعل. وهذه بداية الذكاء العاطفي الحقيقي.`,
          ...
          format: 'standard',
          blocks: [
            { kind: 'paragraph', id: 'ep-lead', tone: 'lead', textEn: 'Emotions aren\'t random. They move in patterns — trigger → thought → feeling → behavior. Once you can SEE your loops, you can break them. Until then, they run you.', textAr: 'المَشاعِرُ لَيْسَتْ عَشْوائيَّة. تَتَحَرَّكُ بِأَنْماط — مُحَفِّز ← فِكْرَة ← شُعور ← سُلوك. مَتى تَرَيْنَ دَوّاماتِك، تَكْسِرينَها. قَبْلَها، تُديرُكِ هي.' },
            { kind: 'framework', id: 'ep-loop', diagram: { type: 'flowchart', titleEn: 'The Emotion Loop', titleAr: 'دَوّامَةُ الشُّعور', nodes: [ { id: 'trigger', labelEn: 'Trigger', labelAr: 'مُحَفِّز', descriptionEn: 'The event or moment', descriptionAr: 'الحَدَث', color: '#C4636A', position: { x: 50, y: 5 }, insightEn: 'Start noticing your triggers this week. What situations consistently set you off? Awareness is the first crack in the loop.', insightAr: 'اِبْدَئي مُلاحَظَةَ مُحَفِّزاتِكِ هذا الأُسْبوع. أَيُّ مَواقِفَ تُشْعِلُكِ بِاسْتِمْرار؟ الوَعْيُ هو أَوَّلُ شَقٍّ في الدَّوّامَة.' }, { id: 'thought', labelEn: 'Thought', labelAr: 'فِكْرَة', descriptionEn: 'Often automatic, often distorted', descriptionAr: 'غالِباً تِلْقائيَّة', color: '#D4A84B', position: { x: 50, y: 25 }, insightEn: 'Ask yourself: "Is this thought a fact or an interpretation?" Most automatic thoughts are stories, not truths.', insightAr: 'اسْأَلي نَفْسَكِ: "هل هذِهِ الفِكْرَةُ حَقيقَةٌ أَمْ تَفْسير؟" مُعْظَمُ الأَفْكارِ التِّلْقائيَّةِ قِصَص، لا حَقائِق.' }, { id: 'feeling', labelEn: 'Feeling', labelAr: 'شُعور', descriptionEn: 'Physical + emotional', descriptionAr: 'جَسَدِيّ + عاطِفيّ', color: '#5B8FA8', position: { x: 50, y: 50 }, insightEn: 'Place your hand where you feel the emotion in your body. Naming the physical sensation -- "tightness in my chest" -- helps it move through you.', insightAr: 'ضَعي يَدَكِ حَيْثُ تَشْعُرينَ بِالعاطِفَةِ في جَسَدِك. تَسْمِيَةُ الإحْساسِ الجَسَدِيّ -- "ضيقٌ في صَدْري" -- يُساعِدُهُ على المُرور.' }, { id: 'behavior', labelEn: 'Behavior', labelAr: 'سُلوك', descriptionEn: 'What you do next', descriptionAr: 'ما تَفْعَلينَهُ تالياً', color: '#3B8A6E', position: { x: 50, y: 75 }, insightEn: 'Before you act, pause and ask: "What would I do if I was calm right now?" Then do that instead.', insightAr: 'قَبْلَ أَنْ تَتَصَرَّفي، تَوَقَّفي واسْأَلي: "ماذا سَأَفْعَلُ لَوْ كُنْتُ هادِئَةً الآن؟" ثُمَّ اِفْعَلي ذلِك.' }, { id: 'result', labelEn: 'Result', labelAr: 'نَتيجَة', descriptionEn: 'Reinforces or challenges the pattern', descriptionAr: 'تُقَوّي أَوْ تَتَحَدّى النَّمَط', color: '#7A3B5E', position: { x: 50, y: 95 }, insightEn: 'After a strong reaction, journal the full loop: trigger, thought, feeling, behavior, result. Seeing the pattern on paper is how you begin to change it.', insightAr: 'بَعْدَ رَدِّ فِعْلٍ قَوِيّ، دَوِّني الحَلَقَةَ كامِلَة: مُحَفِّز، فِكْرَة، شُعور، سُلوك، نَتيجَة. رُؤْيَةُ النَّمَطِ على الوَرَقِ بِدايَةُ تَغْييرِه.' } ], connections: [ { from: 'trigger', to: 'thought' }, { from: 'thought', to: 'feeling' }, { from: 'feeling', to: 'behavior' }, { from: 'behavior', to: 'result' } ] } },
            { kind: 'callout', id: 'ep-intervene', variant: 'insight', textEn: 'You can interrupt the loop at any point. The easiest point: between trigger and thought — notice the thought before it runs the chain. Naming your automatic thought is the start of freedom.', textAr: 'يُمْكِنُكِ مُقاطَعَةُ الدَّوّامَةِ في أَيِّ نُقْطَة. الأَسْهَل: بَيْنَ المُحَفِّزِ والفِكْرَة — لاحِظي الفِكْرَةَ قَبْلَ أَنْ تُشَغِّلَ السِّلْسِلَة. تَسْمِيَةُ الفِكْرَةِ التِّلْقائيَّةِ بِدايَةُ الحُرِّيَّة.' },
            { kind: 'micro-quiz', id: 'ep-mq1', question: { textEn: 'Partner says something curt. You feel rage. Best next step?', textAr: 'شَريكٌ يَقولُ شَيْئاً حادّاً. تَشْعُرينَ بِالغَضَب. أَفْضَلُ خُطْوَة؟', options: [ { labelEn: 'Respond immediately', labelAr: 'اُرْدُدي فَوْراً', correct: false, explanationEn: 'The loop runs. You\'ll regret it.', explanationAr: 'الدَّوّامَةُ تَجْري. سَتَنْدَمين.' }, { labelEn: 'Pause. Ask: "What thought am I having about what they just said?"', labelAr: 'تَوَقَّفي. اِسْأَلي: "أَيَّ فِكْرَةٍ لَدَيَّ عَمّا قالَه؟"', correct: true, explanationEn: 'Yes. Naming the thought (usually "he thinks I\'m stupid" or similar) lets you check if it\'s actually true.', explanationAr: 'نَعَم. تَسْمِيَةُ الفِكْرَة (عادَةً "يَظُنُّني غَبيَّة") تُتيحُ لَكِ فَحْصَ صِحَّتِها.' }, { labelEn: 'Swallow it and move on', labelAr: 'اِبْلَعيها واسْتَمِرّي', correct: false, explanationEn: 'Suppression stores the rage. It\'ll surface later, worse.', explanationAr: 'الكَبْتُ يُخَزِّنُ الغَضَب. سَيَظْهَرُ لاحِقاً، أَسْوَأ.' } ] } },
            { kind: 'callout', id: 'ep-drhala', variant: 'dr-hala', textEn: 'Every feeling has a story attached. The feeling is real — but the story might be ancient, inaccurate, or inherited. Question the story. The feeling usually softens.', textAr: 'كُلُّ شُعورٍ لَهُ قِصَّةٌ مُرْفَقَة. الشُّعورُ حَقيقيّ — لَكِنَّ القِصَّةَ قد تَكونُ قَديمَةً، غَيْرَ دَقيقَة، أَوْ مَوْروثَة. تَساءَلي عَنِ القِصَّة. الشُّعورُ عادَةً يَلين.' },
            { kind: 'reflection-prompt', id: 'ep-refl', minWords: 40, promptEn: 'Describe a recent emotional loop: trigger → thought → feeling → behavior → result. What did you LEARN about the pattern?', promptAr: 'صِفي دَوّامَةً حَديثَة: مُحَفِّز ← فِكْرَة ← شُعور ← سُلوك ← نَتيجَة. ماذا تَعَلَّمْتِ عَنِ النَّمَط؟' },
          ],
          learningObjectives: [
          ...
          blocks: [
            { kind: 'paragraph', id: 'sc-lead', tone: 'lead', textEn: 'Self-compassion is not self-indulgence. Research shows it\'s actually MORE motivating than self-criticism. People who are kind to themselves bounce back faster, try harder, and achieve more. This 7-day practice installs the habit.', textAr: 'الرَّحْمَةُ الذّاتيَّةُ لَيْسَتْ تَدْليلاً. الأَبْحاثُ تُبَيِّنُ أَنَّها أَكْثَرُ تَحْفيزاً من النَّقْدِ الذّاتيّ. المُرَحِّمونَ لِأَنْفُسِهِم يَنْهَضونَ أَسْرَعَ، يُحاوِلونَ أَقْوى، يُحَقِّقونَ أَكْثَر. هذِهِ مُمارَسَةُ 7 أَيّامٍ تُرَكِّبُ العادَة.' },
            {
              ...
              diagram: {
                ...
                nodes: [
                  { id: 'kindness', labelEn: 'Self-Kindness', labelAr: 'اللُّطْفُ مع الذّات', descriptionEn: 'Treating yourself with warmth when you suffer or fail — the opposite of harsh self-judgment', descriptionAr: 'مُعامَلَةُ نَفْسِكِ بِدِفْءٍ حينَ تُعانينَ أو تَفْشَلين — عَكْسُ الحُكْمِ القاسي', color: '#C4636A', position: { x: 50, y: 10 }, insightEn: 'When your inner critic speaks, ask: "Would I say this to a friend?" Then say what you would tell her -- to yourself.', insightAr: 'حينَ يَتَكَلَّمُ ناقِدُكِ الدّاخِليّ، اسْأَلي: "هل سَأَقولُ هذا لِصَديقَة؟" ثُمَّ قولي ما سَتَقولينَهُ لَها -- لِنَفْسِك.' },
                  { id: 'humanity', labelEn: 'Common Humanity', labelAr: 'الإنْسانِيَّةُ المُشْتَرَكَة', descriptionEn: 'Recognizing suffering as shared human experience — you are not alone in your struggles', descriptionAr: 'إدْراكُ أنَّ المُعاناةَ تَجْرِبَةٌ إنْسانِيَّةٌ مُشْتَرَكَة — لَسْتِ وَحْدَكِ', color: '#D4A84B', position: { x: 15, y: 80 }, insightEn: 'Try telling yourself: "This is a moment of suffering. Suffering is part of being human. I am not alone in this."', insightAr: 'جَرِّبي أَنْ تَقولي لِنَفْسِك: "هذِهِ لَحْظَةُ مُعاناة. المُعاناةُ جُزْءٌ من الإنْسانيَّة. لَسْتُ وَحْدي في هذا."' },
                  { id: 'mindfulness', labelEn: 'Mindfulness', labelAr: 'اليَقَظَةُ الذِّهْنِيَّة', descriptionEn: 'Holding painful experiences in balanced awareness — neither suppressing nor drowning', descriptionAr: 'اِحْتِضانُ التَّجارِبِ المُؤْلِمَةِ بِوَعْيٍ مُتَوازِن — لا قَمْعٌ ولا غَرَق', color: '#5B8FA8', position: { x: 85, y: 80 }, insightEn: 'Notice the pain without merging with it. Say: "I feel hurt right now" instead of "I AM hurt." That tiny shift creates space.', insightAr: 'لاحِظي الأَلَمَ بِلا اِنْدِماجٍ مَعَه. قولي: "أَشْعُرُ بِأَلَمٍ الآن" بَدَلَ "أَنا مُتَأَلِّمَة." هذا التَّحَوُّلُ الصَّغيرُ يَخْلُقُ مَساحَة.' },
                ],
                connections: [
            ...
            { kind: 'challenge-step', id: 'sc-d1', dayLabel: 1, titleEn: 'Catch One Inner Critic', titleAr: 'اِلْتَقِطي ناقِداً داخِليّاً', instructionEn: 'Notice ONE critical thought today. Write it down. Don\'t fix it. Just see it.', instructionAr: 'لاحِظي فِكْرَةً نَقْديَّةً واحِدَةً اليَوْم. اُكْتُبيها. لا تُصْلِحيها. فَقَطْ راقِبيها.', checkInPromptEn: 'What did you hear?', checkInPromptAr: 'ماذا سَمِعْتِ؟' },
            { kind: 'challenge-step', id: 'sc-d2', dayLabel: 2, titleEn: 'What Would You Say to a Friend?', titleAr: 'ماذا تَقولينَ لِصَديقَة؟', instructionEn: 'Take yesterday\'s critical thought. Imagine your best friend saying it about themselves. What would you tell HER? Say that to yourself.', instructionAr: 'خُذي فِكْرَةَ الأَمْسِ النَّقْديَّة. تَخَيَّلي صَديقَتَكِ تَقولُها عَنْ نَفْسِها. ماذا تَقولينَ لَها؟ قوليها لِنَفْسِكِ.', checkInPromptEn: 'What\'s the gap between what you said to yourself and what you\'d say to a friend?', checkInPromptAr: 'الفَجْوَةُ بَيْنَ ما تَقولينَ لِنَفْسِكِ ولِصَديقَة؟' },
            { kind: 'challenge-step', id: 'sc-d3', dayLabel: 3, titleEn: 'Name a Failure Kindly', titleAr: 'سَمّي فَشَلاً بِلُطْف', instructionEn: 'Think of something you failed at recently. Write a kind sentence about it — the kind you\'d use with someone you love.', instructionAr: 'فَكِّري في شَيْءٍ فَشِلْتِ فيهِ. اُكْتُبي جُمْلَةً لَطيفَةً عَنْه — مِنَ النَّوْعِ الّذي تَسْتَخْدِمينَهُ مع من تُحِبّين.', checkInPromptEn: 'What kind sentence did you write?', checkInPromptAr: 'ما الجُمْلَةُ اللَّطيفَة؟' },
            { kind: 'challenge-step', id: 'sc-d4', dayLabel: 4, titleEn: 'Hand on Heart', titleAr: 'يَدٌ على القَلْب', instructionEn: 'When you notice stress today, place a hand on your heart for 30 seconds. Say (silently): "This is hard. I\'m human. I\'m doing my best." That\'s it.', instructionAr: 'حينَ تُلاحِظينَ تَوَتُّراً اليَوْم، ضَعي يَداً على قَلْبِكِ 30 ثانِيَة. قولي (بِصَمْت): "هذا صَعْب. أَنا إنْسانَة. أَفْعَلُ ما بِوِسْعي." هذا كُلُّ شَيْء.', checkInPromptEn: 'When did you do it? How did it feel?', checkInPromptAr: 'مَتى فَعَلْتِ؟ كَيْفَ كانَ الشُّعور؟' },
            { kind: 'challenge-step', id: 'sc-d5', dayLabel: 5, titleEn: 'The Letter', titleAr: 'الرِّسالَة', instructionEn: 'Write a short letter to yourself from the perspective of someone who loves you unconditionally. What would they say about how you\'re doing?', instructionAr: 'اُكْتُبي رِسالَةً قَصيرَةً لِنَفْسِكِ من مَنْظورِ شَخْصٍ يُحِبُّكِ بِلا شَرْط. ماذا سَيَقولُ عَنْ كَيْفَ تَفْعَلين؟', checkInPromptEn: 'What did the letter say?', checkInPromptAr: 'ماذا قالَتِ الرِّسالَة؟' },
            { kind: 'challenge-step', id: 'sc-d6', dayLabel: 6, titleEn: 'Choose Your Words', titleAr: 'اخْتاري كَلِماتِك', instructionEn: 'Catch yourself in self-talk today. Replace "I\'m such an idiot" with "I made a mistake. That\'s human." Just swap the words.', instructionAr: 'اِلْتَقِطي حَديثَكِ الذّاتيَّ اليَوْم. اِسْتَبْدِلي "يا لي من غَبيَّة" بِـ "أَخْطَأْتُ. هذا إنْسانيّ." فَقَطْ بَدِّلي الكَلِمات.', checkInPromptEn: 'What phrase did you swap?', checkInPromptAr: 'أَيَّ عِبارَةٍ بَدَّلْتِ؟' },
            { kind: 'challenge-step', id: 'sc-d7', dayLabel: 7, titleEn: 'Integration', titleAr: 'اِنْدِماج', instructionEn: 'Look at the week. Which practice felt MOST like home? Keep that one. The others are options.', instructionAr: 'اُنْظُري لِلأُسْبوع. أَيَّ مُمارَسَةٍ شَعَرَتْ أَكْثَرَ بِالبَيْت؟ اِحْتَفِظي بِها. البَقيَّةُ خِيارات.', checkInPromptEn: 'Which practice are you keeping?', checkInPromptAr: 'أَيَّ مُمارَسَةٍ تَحْتَفِظين؟' },
            { kind: 'callout', id: 'sc-drhala', variant: 'dr-hala', textEn: 'You speak to yourself more than anyone else speaks to you. Make that voice one you\'d want to live with for 80 years — because you will.', textAr: 'تَتَحَدَّثينَ لِنَفْسِكِ أَكْثَرَ من أَيِّ شَخْصٍ يَتَحَدَّثُ لَكِ. اِجْعَلي ذلِكَ الصَّوْتَ واحِداً تُريدينَ العَيْشَ مَعَهُ 80 سَنَة — لِأَنَّكِ سَتَفْعَلين.' },
          ],
          learningObjectives: [
...
من المهم التعامل مع هذا العمل برحمة بدلًا من الإحباط. هذه الدورات ليست دليلًا على الضعف — إنها مسارات عصبية متجذّرة بعمق تستغرق وقتًا وصبرًا لإعادة برمجتها. في كل مرة تلاحظ فيها نمطًا، أنت تحرز تقدمًا بالفعل. في كل مرة تختار فيها بشكل مختلف، حتى لو بشكل ناقص، أنت ترسم مسارًا عصبيًا جديدًا. التغيير لا يتعلق بإزالة النمط القديم — بل ببناء نمط جديد يصبح تدريجيًا أقوى.`,
          ...
          blocks: [
            ...
            { kind: 'callout', id: 'bc-lesson', variant: 'insight', textEn: 'Unhelpful patterns are always protecting you from something — usually a feeling you don\'t want to feel. Breaking the pattern means FEELING that thing. It\'s uncomfortable. It\'s also how you get your life back.', textAr: 'الأَنْماطُ غَيْرُ المُفيدَةِ تَحْميكِ من شَيْء — عادَةً شُعورٌ لا تُريدينَ الشُّعورَ بِه. كَسْرُ النَّمَطِ يَعْني الشُّعورَ بِذلِك. مُزْعِج. وهكَذا تَسْتَعيدينَ حَياتَك.' },
            { kind: 'callout', id: 'bc-drhala', variant: 'dr-hala', textEn: 'I never ask clients to "just stop" a pattern. I ask: "What would you have to feel if you stopped?" That question unlocks everything. The pattern isn\'t the enemy. It\'s a messenger.', textAr: 'لا أَطْلُبُ من عُمَلائي "التَّوَقُّفَ" عَنْ نَمَط. أَسْأَل: "ماذا سَتَشْعُرينَ لَوْ تَوَقَّفْتِ؟" هذا السُّؤالُ يَفْتَحُ كُلَّ شَيْء. النَّمَطُ لَيْسَ العَدُوّ. إنَّهُ رَسول.' },
            { kind: 'reflection-prompt', id: 'bc-refl', minWords: 50, promptEn: 'What\'s one pattern you keep repeating that you wish you could stop? What would you have to FEEL if you stopped?', promptAr: 'ما نَمَطٌ تُكَرِّرينَهُ وتَتَمَنَّيْنَ التَّوَقُّفَ عَنْه؟ ماذا سَتَشْعُرينَ لَوْ تَوَقَّفْتِ؟' },
          ],
          learningObjectives: [
...
تشمل الاستراتيجيات الرئيسية للتعامل مع التحولات: السماح لنفسك بالحزن على ما فُقد (حتى لو قلّل الآخرون منه)، وإيجاد أو خلق طقوس تحتفي بالعبور، والبحث عن دعم من أشخاص عبروا تحولات مماثلة، والحفاظ على أجزاء روتينك وهويتك التي تُرسّخك، ومنح نفسك الإذن بألا يكون كل شيء واضحًا فورًا. المنطقة المحايدة ليست فشلًا — إنها جزء ضروري من التحوّل.`,
          ...
          format: 'standard',
          blocks: [
            { kind: 'paragraph', id: 'lt-lead', tone: 'lead', textEn: 'Life transitions — divorce, moving, illness, career shifts, loss — don\'t come with a manual. The goal isn\'t to "get through" them. It\'s to meet them with grace: present, patient, and open to who you\'re becoming.', textAr: 'الاِنْتِقالاتُ الحَياتيَّة — طَلاق، اِنْتِقال، مَرَض، تَحَوُّلاتُ عَمَل، فَقْد — لا تَأْتي بِدَليل. الهَدَفُ لَيْسَ "اجْتِيازَها". بَلْ مُقابَلَتَها بِرَوْعَة: حاضِرَة، صَبورَة، مُنْفَتِحَةٌ عَلى من تَصيرين.' },
...
بناء المرونة تجاه الضغط مهارة وليس سمة. يمكن تطويرها في أي عمر من خلال الممارسة المتسقة. في كل مرة تواجه فيها تحديًا وتديره بفعالية وتتعافى منه — أنت تدرّب جهازك العصبي على أنك تستطيع التعامل مع الصعوبات. هذا التراكم من الكفاءة هو أساس الثقة الحقيقية.`,
          ...
          format: 'cards',
          blocks: [
            { kind: 'card', id: 'ss-intro', accentColor: '#7A3B5E', titleEn: 'Stress isn\'t the enemy — stuck stress is', titleAr: 'التَّوَتُّرُ لَيْسَ العَدُوّ — المَحْبوسُ هو', bodyEn: 'Stress is your nervous system\'s signal that something matters. Managed well, it sharpens you. Unmanaged, it corrodes you. These 6 cards teach reframes that turn stress into strength.', bodyAr: 'التَّوَتُّرُ إشارَةٌ من جِهازِكِ العَصَبِيّ. مُدارٌ جَيِّداً، يُشَحِّذُكِ. غَيْرُ مُدار، يَأْكُلُكِ. هذِهِ 6 بِطاقاتٍ تَقْلِبُ التَّوَتُّرَ قُوَّة.' },
            { kind: 'card', id: 'ss-reframe', accentColor: '#C4878A', titleEn: '1. Reframe the Body Signal', titleAr: '1. أَعيدي تَأْطيرَ الإشارَة', bodyEn: 'Old: "My heart is racing — I\'m panicking."\n\nNew: "My body is preparing me. This is energy, not danger."\n\nResearch: people who reframed stress as helpful performed better AND had better heart health.', bodyAr: 'قَديم: "قَلْبي يَتَسارَع — أَنا في هَلَع."\n\nجَديد: "جَسَدي يُحَضِّرُني. طاقَة، لا خَطَر."\n\nبَحْثٌ: من يُعيدونَ التَّأْطيرَ يُؤَدّونَ أَفْضَل ولَدَيْهِم صِحَّةُ قَلْبٍ أَفْضَل.' },
            { kind: 'card', id: 'ss-move', accentColor: '#5B8FA8', titleEn: '2. Move the Stress OUT', titleAr: '2. حَرِّكي التَّوَتُّرَ خارِجاً', bodyEn: 'Walk briskly 10 min. Dance 3 songs. Shake your hands for 30 seconds. Stress is energy — give it somewhere to go.', bodyAr: 'اِمْشي بِسُرْعَةٍ 10 دَقائِق. اِرْقُصي 3 أَغانٍ. هُزّي يَدَيْكِ 30 ثانِيَة. التَّوَتُّرُ طاقَة — أَعْطيهِ مَنْفَذاً.' },
            { kind: 'micro-quiz', id: 'ss-mq1', question: { textEn: 'Research-backed best-practice for acute stress:', textAr: 'أَفْضَلُ مُمارَسَةٍ لِلتَّوَتُّرِ الحادّ:', options: [ { labelEn: 'Deep analysis', labelAr: 'تَحْليلٌ عَميق', correct: false, explanationEn: 'Analysis rarely helps. Body first.', explanationAr: 'التَّحْليلُ نادِراً ما يُفيد.' }, { labelEn: 'Slow exhale (longer out than in)', labelAr: 'زَفيرٌ بَطيء', correct: true, explanationEn: 'Yes. Long exhales activate the parasympathetic nervous system.', explanationAr: 'نَعَم. يُفَعِّلُ النِّظامَ نَظيرَ الوُدّيّ.' }, { labelEn: 'Wait it out', labelAr: 'اِنْتَظِريه', correct: false, explanationEn: 'Waiting extends stress.', explanationAr: 'الاِنْتِظارُ يُطيلُ التَّوَتُّر.' } ] } },
            { kind: 'card', id: 'ss-name', accentColor: '#C8A97D', titleEn: '3. Name What\'s Actually Happening', titleAr: '3. سَمّي ما يَحْدُثُ فِعْلاً', bodyEn: '"I\'m stressed" is too broad. Try:\n• "I\'m afraid I\'ll disappoint her."\n• "I\'m angry I have to do this alone."\n• "Too many decisions at once."\n\nNaming creates distance. Distance creates choice.', bodyAr: '"مُتَوَتِّرَة" عامّ. جَرِّبي:\n• "أَخافُ أَنْ أُخَيِّبَها."\n• "غاضِبَةٌ أَنَّ عَلَيَّ وَحْدي."\n• "قَراراتٌ كَثيرَةٌ مَعاً."\n\nالتَّسْمِيَةُ تَخْلُقُ مَسافَة.' },
            { kind: 'card', id: 'ss-pruning', accentColor: '#3B8A6E', titleEn: '4. Prune, Don\'t Push Through', titleAr: '4. قَصّي، لا تَدْفَعي', bodyEn: 'When stressed, ambitious people ADD more. Better: subtract. Cancel one thing this week. Say no to one obligation. Delete one tab.', bodyAr: 'المُتَوَتِّرونَ الطَّموحونَ يُضيفون. أَفْضَل: اِطْرَحي. أَلْغي شَيْئاً. قولي لا لِواجِبٍ. أَغْلِقي تَبويباً.' },
            { kind: 'card', id: 'ss-fuel', accentColor: '#D4A84B', titleEn: '5. Fuel the System', titleAr: '5. وَقّدي النِّظام', bodyEn: 'Stressed systems need basics MORE:\n• Sleep before 11pm\n• Water first thing\n• Protein each meal\n• 15 min outside daily', bodyAr: 'الأَنْظِمَةُ المُتَوَتِّرَةُ تَحْتاجُ الأَساسَ أَكْثَر:\n• نَوْمٌ قَبْلَ الـ 11\n• ماء\n• بْروتين\n• 15 دَقيقَةً في الخارِج' },
            { kind: 'card', id: 'ss-drhala', accentColor: '#7A3B5E', titleEn: 'The Stress Translation', titleAr: 'تَرْجَمَةُ التَّوَتُّر', bodyEn: 'Stress = care without capacity.\n\nYou\'re not broken. You\'re stretched beyond your system. The answer is rarely "try harder." It\'s "grow capacity" OR "reduce load."', bodyAr: 'التَّوَتُّر = اِهْتِمامٌ بِلا طاقَة.\n\nلَسْتِ مَكْسورَة. مَمْدودَةٌ أَبْعَدَ من نِظامِك. الجَوابُ "وَسِّعي طاقَتَك" أَوْ "خَفِّفي الحِمْل".' },
          ],
          learningObjectives: [
...
تذكّر: الأشخاص الذين يتفاعلون سلبًا مع حدودك هم غالبًا الذين استفادوا أكثر من غياب حدودك. الأشخاص الأصحاء يحترمون الحدود. هذا ليس سهل السماع دائمًا، خاصة حين يكون الشخص المقاوم لحدّك أحد الوالدين أو شريكًا أو صديقًا مقرّبًا — لكنه يبقى صحيحًا. حدودك ليست رفضًا للآخرين؛ إنها تعبير عن احترام الذات. ومن أساس احترام الذات، أنت في الواقع قادر على العطاء بسخاء أكبر، لأن عطاءك يأتي من الاختيار لا من الالتزام.`,
          ...
          format: 'cards',
          blocks: [
            { kind: 'card', id: 'bf-intro', accentColor: '#7A3B5E', titleEn: 'Boundaries aren\'t walls — they\'re doors with locks', titleAr: 'الحُدودُ لَيْسَتْ جُدْراناً — أَبْوابٌ بِأَقْفال', bodyEn: 'A wall keeps everyone out. A boundary is a door YOU control. You decide who comes through, when, and for what. These 6 scripts open boundary conversations you\'ve been avoiding.', bodyAr: 'الجِدارُ يَحْجُبُ الكُلّ. الحَدُّ بابٌ تَتَحَكَّمينَ بِه. أَنْتِ تُقَرِّرينَ من يَدْخُل، مَتى، لِماذا. هذِهِ 6 سِينَاريوهاتٍ تَفْتَحُ مُحادَثاتِ حُدودٍ كُنْتِ تَتَجَنَّبينَها.' },
            {
              ...
              diagram: {
                ...
                nodes: [
                  { id: 'none', labelEn: 'No Boundaries', labelAr: 'بِلا حُدود', descriptionEn: 'Say yes to everything. Invisible needs. Chronic resentment and exhaustion.', descriptionAr: 'نَعَم لِكُلِّ شَيْء. حاجاتٌ غَيْرُ مَرْئيَّة. اِسْتِياءٌ وإنْهاكٌ مُزْمِن.', color: '#C4636A', position: { x: 8, y: 50 }, insightEn: 'If you feel resentful after saying yes, that resentment is a signal: a boundary was needed there. Listen to it.', insightAr: 'إذا شَعَرْتِ بِالاسْتِياءِ بَعْدَ قَوْلِ نَعَم، فَالاسْتِياءُ إشارَة: كانَ هُناكَ حاجَةٌ لِحَدّ. اسْتَمِعي لَه.' },
                  { id: 'porous', labelEn: 'Porous', labelAr: 'مَسامِيَّة', descriptionEn: 'Boundaries exist but collapse under pressure — guilt, family, culture.', descriptionAr: 'حُدودٌ مَوْجودَةٌ لَكِنَّها تَنْهارُ تَحْتَ الضَّغْط — ذَنْب، عائِلَة، ثَقافَة.', color: '#D4A84B', position: { x: 30, y: 50 }, insightEn: 'Practice this script: "I need to think about it. I will get back to you." Buying time protects porous boundaries from pressure.', insightAr: 'تَمَرَّني على هذِهِ العِبارَة: "أَحْتاجُ أَنْ أُفَكِّر. سَأَعودُ إلَيْك." شِراءُ الوَقْتِ يَحْمي الحُدودَ المَسامِيَّةَ من الضَّغْط.' },
            ...
            { kind: 'card', id: 'bf-guilt', accentColor: '#C4636A', titleEn: '5. Handling the Guilt', titleAr: '5. التَّعامُلُ مع الذَّنْب', bodyEn: 'After saying no, you may feel guilty. That\'s normal.\n\nScript for yourself: "Guilt doesn\'t mean I\'m wrong. It means I\'m breaking a pattern. I can feel this AND keep the boundary."', bodyAr: 'بَعْدَ قَوْلِ لا، قد تَشْعُرينَ بِذَنْب. طَبيعِيّ.\n\nسِينَاريو لِنَفْسِك: "الذَّنْبُ لا يَعْني أَنّي مُخْطِئَة. يَعْني أَنّي أَكْسِرُ نَمَطاً. أَشْعُرُ بِهذا وأَحْفَظُ الحَدّ."' },
          ...
          blocks: [
            { kind: 'paragraph', id: 'fp-lead', tone: 'lead', textEn: 'Purpose isn\'t something you discover — it\'s something you construct, test, and refine. The question isn\'t "what\'s my one true calling?" It\'s: "What, right now, would I be proud to be known for?"', textAr: 'الهَدَفُ لَيْسَ شَيْئاً تَكْتَشِفينَه — شَيْءٌ تَبْنينَه، تَخْتَبِرينَه، تُحَسِّنينَه. السُّؤالُ لَيْسَ "ما نِدائي الوَحيد؟" بَلْ: "ماذا، الآن، أَفْتَخِرُ بِأَنْ أُعْرَفَ بِه؟"' },
            {
              ...
              diagram: {
                ...
                nodes: [
                  { id: 'love', labelEn: 'What You Love', labelAr: 'ما تُحِبّ', descriptionEn: 'Passion — activities that make time disappear and light you up from within', descriptionAr: 'الشَّغَف — أَنْشِطَةٌ تُذيبُ الوَقْتَ وتُضيءُكِ من الدّاخِل', color: '#C4636A', position: { x: 25, y: 25 }, insightEn: 'What makes time disappear for you? That feeling is data. Follow the energy, not the "should."', insightAr: 'ما الّذي يُذيبُ الوَقْتَ لَكِ؟ ذلِكَ الشُّعورُ بَيانات. اتَّبِعي الطّاقَة، لا "يَجِب."' },
                  { id: 'need', labelEn: 'What the World Needs', labelAr: 'ما يَحْتاجُهُ العالَم', descriptionEn: 'Mission — problems that bother you, injustice you want to fix', descriptionAr: 'الرِّسالَة — مَشاكِلُ تُزْعِجُكِ، ظُلْمٌ تُريدينَ إصْلاحَه', color: '#5B8FA8', position: { x: 75, y: 25 }, insightEn: 'What breaks your heart when you see it in the world? That heartbreak is pointing toward your mission.', insightAr: 'ما الّذي يَكْسِرُ قَلْبَكِ حينَ تَرَيْنَهُ في العالَم؟ ذلِكَ الحُزْنُ يُشيرُ إلى رِسالَتِك.' },
                  { id: 'good', labelEn: 'What You\'re Good At', labelAr: 'ما تُجيدينَه', descriptionEn: 'Vocation — skills people come to you for, your natural strengths', descriptionAr: 'الحِرْفَة — مَهاراتٌ يَأْتي إلَيْكِ النّاسُ لِأَجْلِها، قُوّاتُكِ الطَّبيعِيَّة', color: '#D4A84B', position: { x: 25, y: 75 }, insightEn: 'Ask three people you trust: "What do you come to me for?" Their answers reveal strengths you cannot see from the inside.', insightAr: 'اسْأَلي 3 أَشْخاصٍ تَثِقينَ بِهِم: "لِماذا تَأْتونَ إلَيَّ؟" إجاباتُهُم تَكْشِفُ نِقاطَ قُوَّةٍ لا تَرَيْنَها من الدّاخِل.' },
                  { id: 'paid', labelEn: 'What Sustains You', labelAr: 'ما يُعيلُكِ', descriptionEn: 'Profession — work that provides financial stability and security', descriptionAr: 'المِهْنَة — عَمَلٌ يُوَفِّرُ الاسْتِقْرارَ الماليَّ والأَمان', color: '#3B8A6E', position: { x: 75, y: 75 }, insightEn: 'Purpose does not have to be your paycheck. Sometimes purpose lives in the volunteer work, the parenting, the small acts that sustain your soul.', insightAr: 'الهَدَفُ لا يَجِبُ أَنْ يَكونَ راتِبَكِ. أَحْياناً الهَدَفُ يَعيشُ في العَمَلِ التَّطَوُّعِيّ، التَّرْبِيَة، الأَفْعالِ الصَّغيرَةِ الّتي تُغَذّي روحَكِ.' },
                ],
                connections: [],
              },
            },
            { kind: 'likert', id: 'fp-lk1', reflection: { titleEn: 'Clarity', titleAr: 'وُضوح', statementEn: 'I can name, in one sentence, what I want my life to be ABOUT.', statementAr: 'أَسْتَطيعُ تَسْمِيَةً في جُمْلَةٍ ما أُريدُ لِحَياتي.', scaleLabels: { lowEn: 'Unclear', lowAr: 'غَيْرُ واضِح', highEn: 'Clear', highAr: 'واضِح' }, interpretations: [ { min: 1, max: 2, labelEn: 'Searching', labelAr: 'تَبْحَثين', feedbackEn: 'Write 3 drafts this week.', feedbackAr: 'اُكْتُبي 3 مُسَوَّدات.' }, { min: 3, max: 5, labelEn: 'Forming', labelAr: 'يَتَشَكَّل', feedbackEn: 'Compress to one sentence.', feedbackAr: 'اضْغَطيها في جُمْلَة.' }, { min: 6, max: 7, labelEn: 'Clear', labelAr: 'واضِح', feedbackEn: 'Save it. Read monthly.', feedbackAr: 'اِحْفَظيها.' } ] } },
            { kind: 'likert', id: 'fp-lk2', reflection: { titleEn: 'Alignment', titleAr: 'تَوافُق', statementEn: 'My daily choices reflect my purpose.', statementAr: 'اخْتِياراتي اليَوْميَّةُ تَعْكِسُ هَدَفي.', scaleLabels: { lowEn: 'Out of sync', lowAr: 'خارِج', highEn: 'Aligned', highAr: 'مُتَوافِقَة' }, interpretations: [ { min: 1, max: 2, labelEn: 'Life runs you', labelAr: 'الحَياةُ تُديرُكِ', feedbackEn: 'Start one 15-min aligned block this week.', feedbackAr: 'ابْدَئي 15 دَقيقَةً مُتَوافِقَة.' }, { min: 3, max: 5, labelEn: 'Partial', labelAr: 'جُزْئيّ', feedbackEn: 'Grow the aligned blocks.', feedbackAr: 'اِنْمي الكُتَلَ.' }, { min: 6, max: 7, labelEn: 'Lived', labelAr: 'مَعيش', feedbackEn: 'Rare.', feedbackAr: 'نادِر.' } ] } },
            { kind: 'likert', id: 'fp-lk3', reflection: { titleEn: 'Energy', titleAr: 'طاقَة', statementEn: 'My purpose energizes me more than it exhausts me.', statementAr: 'هَدَفي يُنْعِشُني أَكْثَرَ مِمّا يُنْهِكُني.', scaleLabels: { lowEn: 'Drains', lowAr: 'يَسْتَنْزِف', highEn: 'Fuels', highAr: 'يُغَذّي' }, interpretations: [ { min: 1, max: 2, labelEn: 'Wrong purpose', labelAr: 'هَدَفٌ خاطِئ', feedbackEn: 'If it drains you, it may not be yours.', feedbackAr: 'إذا اسْتَنْزَفَكِ، قَدْ لا يَكون لَكِ.' }, { min: 3, max: 5, labelEn: 'Mixed', labelAr: 'مُخْتَلِط', feedbackEn: 'Which parts energize?', feedbackAr: 'أَيُّ أَجْزاءٍ تُنْعِش؟' }, { min: 6, max: 7, labelEn: 'Energized', labelAr: 'مُفْعَم', feedbackEn: 'Protect it.', feedbackAr: 'اِحْمِيه.' } ] } },
            { kind: 'likert', id: 'fp-lk4', reflection: { titleEn: 'Contribution', titleAr: 'مُساهَمَة', statementEn: 'I give something the world specifically needed from ME.', statementAr: 'أُعْطي ما احْتاجَهُ العالَمُ مِنّي.', scaleLabels: { lowEn: 'Invisible', lowAr: 'غَيْرُ مَرْئيَّة', highEn: 'Giving', highAr: 'أُعْطي' }, interpretations: [ { min: 1, max: 2, labelEn: 'Starved', labelAr: 'جائِعَة', feedbackEn: 'Find smallest contribution this week.', feedbackAr: 'أَصْغَرُ مُساهَمَة.' }, { min: 3, max: 5, labelEn: 'Partial', labelAr: 'جُزْئيّ', feedbackEn: 'Name what you\'re giving.', feedbackAr: 'سَمّي ما تُعْطين.' }, { min: 6, max: 7, labelEn: 'Purposeful', labelAr: 'ذو هَدَف', feedbackEn: 'The world is better because of you.', feedbackAr: 'العالَمُ أَفْضَلُ بِوُجودِك.' } ] } },
            ...
            { kind: 'reflection-prompt', id: 'fp-refl', minWords: 50, promptEn: 'Draft your 1-sentence purpose. "I want my life to be about ___." Live with it for a week. Revise.', promptAr: 'اُكْتُبي هَدَفَكِ في جُمْلَة. عيشي أُسْبوعاً. عَدِّلي.' },
          ],
          learningObjectives: [
...
انتقاء عالمك العلائقي هو فعل من أفعال الرعاية الذاتية. هذا لا يعني قطع العلاقات باندفاع، لكنه يعني أن تكون واعيًا بشأن أين تستثمر طاقتك العاطفية المحدودة. اقضِ وقتًا أكثر مع من يتركونك تشعر بالارتقاء ووقتًا أقل مع من يتركونك مستنزفًا باستمرار. استثمر بعمق في بضع علاقات وثيقة بدلًا من توزيع نفسك على علاقات سطحية كثيرة. وتذكّر: علاقتك بنفسك تضع القالب لكل علاقة أخرى في حياتك.`,
          ...
          blocks: [
            ...
            { kind: 'callout', id: 'rn-insight', variant: 'insight', textEn: 'Not "how MANY" relationships — quality. Just 2-3 deeply nourishing relationships can provide the full protective effect. You don\'t need a village. You need a few true ones.', textAr: 'لَيْسَ "كَمْ" عَلاقَة — الجَوْدَة. 2-3 عَلاقاتٍ مُغَذّيَةٍ تَكْفي لِلحِمايَةِ كامِلَةً. لا تَحْتاجينَ قَرْيَة. بَلْ قَليلاً حَقيقيّاً.' },
            { kind: 'comparison', id: 'rn-cmp', titleEn: 'Nourishing vs Draining', titleAr: 'مُغَذّيَة مُقابِلَ مُسْتَنْزِفَة', left: { labelEn: 'Draining', labelAr: 'مُسْتَنْزِفَة', pointsEn: ['You\'re exhausted after contact', 'One-way emotional labor', 'You can\'t be yourself', 'Your needs don\'t matter'], pointsAr: ['مُرْهَقَةٌ بَعْدَ التَّواصُل', 'جُهْدٌ عاطِفِيٌّ من طَرَفٍ واحِد', 'لا تَكونينَ نَفْسَكِ', 'احْتِياجاتُكِ لا تَهُمّ'] }, right: { labelEn: 'Nourishing', labelAr: 'مُغَذّيَة', pointsEn: ['You\'re energized after', 'Mutual give and take', 'You can be fully you', 'Your needs are heard'], pointsAr: ['مُفْعَمَةٌ بَعْدَها', 'أَخْذٌ وعَطاءٌ مُتَبادَل', 'تَكونينَ نَفْسَكِ كامِلاً', 'احْتِياجاتُكِ مَسْموعَة'] } },
            { kind: 'micro-quiz', id: 'rn-mq1', question: { textEn: 'You have a friend who drains you. Best move?', textAr: 'صَديقَةٌ تَسْتَنْزِفُكِ. أَفْضَلُ خُطْوَة؟', options: [ { labelEn: 'Cut them off cold', labelAr: 'اِقْطَعيها فَوْراً', correct: false, explanationEn: 'Sometimes necessary, often abrupt. Try the gentler path first.', explanationAr: 'أَحْياناً ضَرورِيّ، غالِباً قاسٍ. جَرِّبي الأَلْطَفَ أَوَّلاً.' }, { labelEn: 'Reduce frequency + name one thing you need different', labelAr: 'قَلِّلي التَّواتُر + سَمّي شَيْئاً تَحْتاجينَهُ مُخْتَلِفاً', correct: true, explanationEn: 'Yes. Adjust without nuking. Most relationships can be reshaped.', explanationAr: 'نَعَم. عَدِّلي بِلا تَفْجير.' }, { labelEn: 'Wait it out', labelAr: 'اِنْتَظِري', correct: false, explanationEn: 'Waiting doesn\'t change dynamics. Small action does.', explanationAr: 'الاِنْتِظارُ لا يُغَيِّرُ الديناميكيّات.' } ] } },
            { kind: 'callout', id: 'rn-drhala', variant: 'dr-hala', textEn: 'Audit your circle honestly. Which 3 relationships nourish you most? Invest deliberately in those. Which ones are draining you? Name what you need from them — or loosen your grip. Your wellbeing depends on this decision.', textAr: 'افْحَصي دائِرَتَكِ بِصِدْق. أَيُّ 3 عَلاقاتٍ تُغَذّيكِ؟ اسْتَثْمِري فيها. أَيُّها تَسْتَنْزِفُك؟ سَمّي ما تَحْتاجينَه — أَوْ خَفِّفي القَبْضَة. رِفاهِيَّتُكِ تَعْتَمِدُ عَلى هذا القَرار.' },
            { kind: 'reflection-prompt', id: 'rn-refl', minWords: 40, promptEn: 'Name your 3 most nourishing relationships. Name 1 draining one. What\'s one conversation you need to have — with yourself or them — about each?', promptAr: 'سَمّي 3 عَلاقاتٍ مُغَذّيَة. واحِدَة مُسْتَنْزِفَة. ما المُحادَثَةُ المَطْلوبَةُ — مع نَفْسِكِ أَوْ مَعَهُم — لِكُلٍّ؟' },
          ],
          learningObjectives: [
...
التأثير التراكمي لهذه الممارسات اليومية قوي. كل فعل صغير من المرونة — اختيار التنفس بدلًا من ردّ الفعل، التواصل مع صديق، المشي حين تشعر بالإرهاق، إعادة صياغة انتكاسة كفرصة للتعلم — يبني قدرتك للتحدي التالي. مع الوقت، تُطوّر ما يسمّيه الباحثون "الصلابة أمام التوتر": ثقة موثوقة في قدرتك على التعامل مع أي شيء تأتي به الحياة.`,
          ...
          blocks: [
            ...
            { kind: 'challenge-step', id: 'dr-d1', dayLabel: 1, titleEn: 'Morning Anchor (5 min)', titleAr: 'مِرْساةُ الصَّباح (5 دَقائِق)', instructionEn: 'First 5 minutes after waking: no phone. Drink water. Sit quietly. Ask: "What\'s most important today?" Resilience starts with a grounded start.', instructionAr: 'أَوَّلُ 5 دَقائِقَ بَعْدَ الاِسْتِيقاظ: بِلا هاتِف. اِشْرَبي الماء. اِجْلِسي بِصَمْت. اِسْأَلي: "ما الأَهَمّ اليَوْم؟"', checkInPromptEn: 'Did you do it? How did the day start differently?', checkInPromptAr: 'هل فَعَلْتِ؟ كَيْفَ بَدَأَ اليَوْمُ مُخْتَلِفاً؟' },
            { kind: 'challenge-step', id: 'dr-d2', dayLabel: 2, titleEn: 'Name One Emotion', titleAr: 'سَمّي شُعوراً', instructionEn: 'Three times today, pause and name what you\'re feeling: "anxious," "tired," "content." Naming builds emotional literacy, which builds resilience.', instructionAr: '3 مَرّاتٍ اليَوْم، تَوَقَّفي وسَمّي ما تَشْعُرين: "قَلِقَة"، "مُتْعَبَة"، "راضِيَة". التَّسْمِيَةُ تَبْني القِراءَةَ العاطِفيَّة.', checkInPromptEn: 'What 3 emotions did you name?', checkInPromptAr: 'أَيُّ 3 مَشاعِرَ سَمَّيْتِ؟' },
            { kind: 'challenge-step', id: 'dr-d3', dayLabel: 3, titleEn: 'One Small Connection', titleAr: 'تَواصُلٌ صَغيرٌ واحِد', instructionEn: 'Text ONE person a specific appreciation today. Not "hope you\'re well." Specific. "I\'ve been thinking about what you said about X — it helped me."', instructionAr: 'أَرْسِلي لِشَخْصٍ تَقْديراً مُحَدَّداً اليَوْم. لَيْسَ "أَتَمَنّى أَنَّكِ بِخَيْر." مُحَدَّد. "أَفَكِّرُ بِما قُلْتِهِ عَنْ كَذا — أَفادَني."', checkInPromptEn: 'Who did you text? What did you say?', checkInPromptAr: 'لِمَنْ كَتَبْتِ؟ ماذا قُلْتِ؟' },
            { kind: 'challenge-step', id: 'dr-d4', dayLabel: 4, titleEn: 'Move the Body', titleAr: 'حَرِّكي الجَسَد', instructionEn: '20 minutes of movement today. Walk, yoga, dance, stretch. Resilience is physical. No body care = no mental care.', instructionAr: '20 دَقيقَةً من الحَرَكَةِ اليَوْم. مَشْي، يوجا، رَقْص، تَمْديد. المَرونَةُ جَسَديَّة.', checkInPromptEn: 'What did you do? How did it feel?', checkInPromptAr: 'ماذا فَعَلْتِ؟' },
            { kind: 'challenge-step', id: 'dr-d5', dayLabel: 5, titleEn: 'Reframe One Story', titleAr: 'أَعيدي تَأْطيرَ قِصَّةٍ', instructionEn: 'Notice one "I\'m failing" thought today. Rewrite it as: "I\'m learning." Not toxic positivity — honest cognitive flexibility.', instructionAr: 'لاحِظي فِكْرَةَ "أَنا فاشِلَة" اليَوْم. أَعيدي كِتابَتَها: "أَنا أَتَعَلَّم." لَيْسَ إيجابيَّةً سامَّة — مَرونَةٌ صادِقَة.', checkInPromptEn: 'What thought did you reframe?', checkInPromptAr: 'أَيَّ فِكْرَةٍ أَعَدْتِ تَأْطيرَها؟' },
            { kind: 'challenge-step', id: 'dr-d6', dayLabel: 6, titleEn: 'Meaning Moment', titleAr: 'لَحْظَةُ مَعْنى', instructionEn: 'Find ONE moment today that reminded you WHY you\'re doing what you do. Write it in one sentence. File it away.', instructionAr: 'اِبْحَثي عَنْ لَحْظَةٍ واحِدَةٍ اليَوْمَ ذَكَّرَتْكِ لِماذا تَفْعَلينَ ما تَفْعَلين. اُكْتُبيها. اِحْفَظيها.', checkInPromptEn: 'What moment? What did it remind you of?', checkInPromptAr: 'أَيُّ لَحْظَة؟' },
            { kind: 'challenge-step', id: 'dr-d7', dayLabel: 7, titleEn: 'The Keep List', titleAr: 'قائِمَةُ الاِحْتِفاظ', instructionEn: 'Look back at 6 days. Which 3 practices felt most like home? Those are YOUR resilience recipe. Repeat them for 30 days. Track what shifts.', instructionAr: 'اُنْظُري لِلأَيّامِ السِّتَّة. أَيُّ 3 شَعَرَتْ أَكْثَرَ بِالبَيْت؟ تِلْكَ وَصْفَةُ مَرونَتِكِ. كَرِّريها 30 يَوْماً.', checkInPromptEn: 'Which 3 will you keep?', checkInPromptAr: 'أَيَّ 3 سَتَحْتَفِظين؟' },
            { kind: 'callout', id: 'dr-drhala', variant: 'dr-hala', textEn: 'Resilience isn\'t grand. It\'s a thousand tiny choices per day to take care of yourself, stay connected, and choose meaning. You don\'t find it. You install it, one day at a time.', textAr: 'المَرونَةُ لَيْسَتْ عَظيمَة. أَلْفُ اخْتِيارٍ صَغيرٍ يَوْميّاً لِرِعايَةِ نَفْسِكِ، البَقاءِ مُتَواصِلَة، واخْتِيارِ المَعْنى. لا تَجِدينَها. تُرَكِّبينَها يَوْماً بَعْدَ يَوْم.' },
          ],
          learningObjectives: [
...
مع إكمالك لبرنامج البوصلة الداخلية، اعلم أن أهم بوصلة ستحتاجها موجودة بالفعل بداخلك. لطالما عرفت شمالك الحقيقي — البرنامج ببساطة ساعدك في إزالة الضوضاء لتسمعه بوضوح أكبر. ثق بنفسك. عِش بشجاعة. كن لطيفًا مع نفسك على طول الطريق. واعلم أن الدكتورة هالة وفريق ماما هالة يشجّعونك في كل خطوة.`,
          ...
          blocks: [
            ...
            { kind: 'callout', id: 'la-lesson', variant: 'insight', textEn: 'Authenticity isn\'t a personality you HAVE. It\'s a practice you build. Each small authentic act makes the next slightly easier. Nausea fades. Cleanness stays.', textAr: 'الأَصالَةُ لَيْسَتْ شَخْصيَّةً تَمْلِكينَها. مُمارَسَةٌ تَبْنينَها. كُلُّ فِعْلٍ أَصيلٍ يَجْعَلُ التّالي أَسْهَل.' },
            { kind: 'callout', id: 'la-drhala', variant: 'dr-hala', textEn: 'The deepest work: closing the gap between who you are inside and how you show up outside. You don\'t need to be loud. You need to be honest. Start with one sentence. Practice it. Say it. The rest of your life is the reward.', textAr: 'أَعْمَقُ العَمَل: إغْلاقُ الفَجْوَةِ بَيْنَ من أَنْتِ داخِلاً وكَيْفَ تَظْهَرينَ خارِجاً. لا تَحْتاجينَ أَنْ تَكوني عالِيَة. صادِقَة. اِبْدَئي بِجُمْلَة. مارِسيها. قوليها.' },
            { kind: 'reflection-prompt', id: 'la-refl', minWords: 50, promptEn: 'Where are you laughing when you want to push back? What\'s the ONE sentence you need to practice? Write it. Say it aloud 3 times.', promptAr: 'أَيْنَ تَضْحَكينَ وتُريدينَ الاِخْتِلاف؟ ما الجُمْلَةُ الّتي تَحْتاجينَ تَمْرينَها؟ اُكْتُبيها. قوليها 3 مَرّات.' },
          ],
          learningObjectives: [
