...
Children do not need perfect parents. They need present parents. Parents who are willing to see them, hear them, and walk alongside them as they learn to navigate the complex world of emotions. This is the beginning of intentional parenting -- and you are already taking the first step.`,
          ...
          learningObjectives: [
            { textEn: 'Identify the difference between surface behavior and underlying emotional needs in children', textAr: 'حدّد الفرق بين السلوك الظاهري والاحتياجات العاطفية الكامنة عند الأطفال' },
            { textEn: 'Apply the iceberg model to decode common childhood behaviors', textAr: 'طبّق نموذج جبل الجليد لفهم سلوكيات الطفولة الشائعة' },
            { textEn: 'Practice emotional coaching by naming emotions in daily interactions', textAr: 'مارس التدريب العاطفي من خلال تسمية المشاعر في التفاعلات اليومية' },
            { textEn: 'Shift from reactive parenting to emotionally curious parenting', textAr: 'انتقل من التربية الانفعالية إلى التربية القائمة على الفضول العاطفي' },
          ],
          researchCitations: [
            {
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Reactive Mode', labelAr: 'وضع الانفعال', feedbackEn: 'You tend to respond quickly to the behavior you see. This module will help you build the habit of pausing and looking beneath the surface.', feedbackAr: 'تميل إلى الاستجابة بسرعة للسلوك الذي تراه. سيساعدك هذا الدرس على بناء عادة التوقف والنظر تحت السطح.' },
                { min: 4, max: 5, labelEn: 'Growing Awareness', labelAr: 'وعي متنامٍ', feedbackEn: 'You are developing emotional curiosity. With practice, pausing before reacting will become more natural.', feedbackAr: 'أنت تطور فضولاً عاطفياً. مع الممارسة، سيصبح التوقف قبل التفاعل أكثر طبيعية.' },
...
Remember, active listening is not about being a perfect listener every moment of every day. It is about creating enough moments of genuine presence that your child knows, deep in their bones, that they matter to you.`,
          ...
          learningObjectives: [
            { textEn: 'Distinguish between passive hearing and active listening in parent-child interactions', textAr: 'ميّز بين السمع السلبي والاستماع الفعّال في التفاعلات بين الوالد والطفل' },
            { textEn: 'Practice reflective listening by paraphrasing your child\'s words back to them', textAr: 'مارس الاستماع الانعكاسي بإعادة صياغة كلمات طفلك له' },
            { textEn: 'Use open-ended questions to deepen conversations with your child', textAr: 'استخدم الأسئلة المفتوحة لتعميق المحادثات مع طفلك' },
          ],
          researchCitations: [
            {
          ...
          likertReflections: [
            {
              ...
              scaleLabels: { lowEn: 'Rarely', lowAr: 'نادراً', highEn: 'Almost Always', highAr: 'دائماً تقريباً' },
              interpretations: [
                { min: 1, max: 3, labelEn: 'Distracted Listener', labelAr: 'مستمع مشتت', feedbackEn: 'You may be multitasking during conversations. Try committing to one five-minute window of full attention each day.', feedbackAr: 'قد تكون تقوم بمهام متعددة أثناء المحادثات. حاول الالتزام بنافذة من خمس دقائق من الاهتمام الكامل كل يوم.' },
                { min: 4, max: 5, labelEn: 'Developing Presence', labelAr: 'حضور في تطور', feedbackEn: 'You are becoming more aware of your attention. Keep building the habit of full presence during conversations.', feedbackAr: 'أنت تصبح أكثر وعياً باهتمامك. استمر في بناء عادة الحضور الكامل أثناء المحادثات.' },
...
Finally, remember that boundaries are an expression of love. When you hold a limit even as your child protests, you are communicating something deeply reassuring: "I am strong enough to handle your big feelings, and I care enough to keep you safe." This is one of the most loving things a parent can do.`,
          ...
          learningObjectives: [
            { textEn: 'Differentiate between authoritarian, permissive, and authoritative parenting styles', textAr: 'ميّز بين أساليب التربية السلطوية والمتساهلة والحازمة المتوازنة' },
            { textEn: 'Use the empathy-first approach when delivering boundaries', textAr: 'استخدم نهج التعاطف أولاً عند إيصال الحدود' },
            { textEn: 'Apply natural and logical consequences in age-appropriate ways', textAr: 'طبّق العواقب الطبيعية والمنطقية بطرق مناسبة للعمر' },
            { textEn: 'Maintain calm consistency when boundaries are challenged', textAr: 'حافظ على الاتساق الهادئ عند تحدي الحدود' },
          ],
          researchCitations: [
            {
          ...
          likertReflections: [
            {
              ...
              scaleLabels: { lowEn: 'Rarely', lowAr: 'نادراً', highEn: 'Almost Always', highAr: 'دائماً تقريباً' },
              interpretations: [
                { min: 1, max: 3, labelEn: 'Flexible to a Fault', labelAr: 'مرن بشكل مبالغ فيه', feedbackEn: 'You may be giving in to avoid conflict. Remember that consistency is what makes boundaries feel safe for your child.', feedbackAr: 'قد تكون تستسلم لتجنب النزاع. تذكر أن الاتساق هو ما يجعل الحدود تشعر بالأمان لطفلك.' },
                { min: 4, max: 5, labelEn: 'Finding Balance', labelAr: 'في طور إيجاد التوازن', feedbackEn: 'You hold boundaries sometimes but waver under pressure. Identify your non-negotiables and practice holding those firmly.', feedbackAr: 'تحافظ على الحدود أحياناً لكنك تتردد تحت الضغط. حدّد أمورك غير القابلة للتفاوض وتدرّب على الحفاظ عليها بحزم.' },
...
Finally, be gentle with yourself when rituals are missed. Life is unpredictable. The power of a ritual is not in its perfection but in its presence. Even when things fall apart, returning to your family's rituals is a way of saying, "We always come back to each other."`,
          ...
          learningObjectives: [
            { textEn: 'Distinguish between routines (functional) and rituals (emotionally meaningful)', textAr: 'ميّز بين الروتين (الوظيفي) والطقوس (ذات المعنى العاطفي)' },
            { textEn: 'Design at least one new family ritual for a transition moment', textAr: 'صمّم طقساً عائلياً جديداً واحداً على الأقل للحظة انتقالية' },
            { textEn: 'Incorporate cultural heritage elements into daily family rituals', textAr: 'أدمج عناصر التراث الثقافي في طقوس الأسرة اليومية' },
          ],
          researchCitations: [
            {
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Ritual Opportunity', labelAr: 'فرصة للطقوس', feedbackEn: 'Your family could benefit from intentionally building rituals. Start with one small moment of connection per day.', feedbackAr: 'يمكن لعائلتك الاستفادة من بناء الطقوس عن قصد. ابدأ بلحظة تواصل صغيرة واحدة في اليوم.' },
                { min: 4, max: 5, labelEn: 'Growing Rituals', labelAr: 'طقوس نامية', feedbackEn: 'You have some meaningful moments. Consider adding rituals at key transitions like morning goodbyes or bedtime.', feedbackAr: 'لديك بعض اللحظات ذات المعنى. فكّر في إضافة طقوس عند الانتقالات الرئيسية مثل وداع الصباح أو وقت النوم.' },
...
Over time, the co-regulation you provide becomes the template for your child's self-regulation. The calm voice you use becomes their inner voice. The breathing strategies you model become their own coping tools. You are literally building the emotional architecture of their brain, one regulated moment at a time.`,
          ...
          learningObjectives: [
            { textEn: 'Explain the neuroscience behind why children cannot self-regulate during emotional flooding', textAr: 'وضّح العلم العصبي وراء عدم قدرة الأطفال على التنظيم الذاتي أثناء الغمر العاطفي' },
            { textEn: 'Practice co-regulation techniques including calm voice, gentle touch, and slow breathing', textAr: 'مارس تقنيات التنظيم المشترك بما في ذلك الصوت الهادئ واللمس اللطيف والتنفس البطيء' },
            { textEn: 'Identify personal triggers that dysregulate your own nervous system', textAr: 'حدّد المحفزات الشخصية التي تُربك جهازك العصبي' },
            { textEn: 'Distinguish between co-regulation and emotional absorption', textAr: 'ميّز بين التنظيم المشترك والامتصاص العاطفي' },
          ],
          researchCitations: [
            {
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Punishment-Focused', labelAr: 'يركز على العقاب', feedbackEn: 'Your instinct leans toward punishment. Consider whether your child is learning the lesson or just learning to avoid getting caught.', feedbackAr: 'غريزتك تميل نحو العقاب. فكّر فيما إذا كان طفلك يتعلم الدرس أم يتعلم فقط تجنب أن يُكشف أمره.' },
                { min: 4, max: 5, labelEn: 'In Transition', labelAr: 'في مرحلة انتقالية', feedbackEn: 'You are shifting toward teaching-based discipline. Keep practicing calm enforcement and logical consequences.', feedbackAr: 'أنت تتحول نحو التأديب القائم على التعليم. استمر في ممارسة التطبيق الهادئ والعواقب المنطقية.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Screen Imbalance', labelAr: 'خلل في توازن الشاشة', feedbackEn: 'Screens may be crowding out important activities. Consider establishing screen-free zones and times as a starting point.', feedbackAr: 'قد تكون الشاشات تزاحم الأنشطة المهمة. فكّر في إنشاء مناطق وأوقات خالية من الشاشات كنقطة بداية.' },
                { min: 4, max: 5, labelEn: 'Working Toward Balance', labelAr: 'العمل نحو التوازن', feedbackEn: 'You are aware of the balance but could strengthen your screen-free boundaries. A family media agreement could help.', feedbackAr: 'أنت واعٍ بالتوازن لكن يمكنك تعزيز حدودك الخالية من الشاشات. اتفاقية إعلام عائلية قد تساعد.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Shared Attention Only', labelAr: 'اهتمام مشترك فقط', feedbackEn: 'Your children may be competing for individual attention. Even 15 minutes of dedicated time per child can significantly reduce rivalry.', feedbackAr: 'أطفالك قد يتنافسون على الاهتمام الفردي. حتى ١٥ دقيقة من الوقت المخصص لكل طفل يمكن أن تقلل التنافس بشكل كبير.' },
                { min: 4, max: 5, labelEn: 'Occasional Individual Time', labelAr: 'وقت فردي من حين لآخر', feedbackEn: 'You sometimes create individual moments. Try making this more predictable so each child can count on their special time.', feedbackAr: 'أنت تخلق أحياناً لحظات فردية. حاول جعل هذا أكثر قابلية للتوقع حتى يعتمد كل طفل على وقته الخاص.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Rescue Mode', labelAr: 'وضع الإنقاذ', feedbackEn: 'Your protective instincts are strong, but rescuing can reinforce avoidance. Practice validating while gently encouraging approach.', feedbackAr: 'غرائزك الحمائية قوية لكن الإنقاذ يمكن أن يعزز التجنب. تدرب على التأكيد العاطفي مع التشجيع اللطيف على المواجهة.' },
                { min: 4, max: 5, labelEn: 'Learning to Balance', labelAr: 'تعلّم التوازن', feedbackEn: 'You are working on finding the balance between support and allowing your child to face manageable challenges.', feedbackAr: 'أنت تعمل على إيجاد التوازن بين الدعم والسماح لطفلك بمواجهة تحديات يمكن التعامل معها.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Cultural Disconnect', labelAr: 'انفصال ثقافي', feedbackEn: 'Your children may be missing a vital source of identity and belonging. Start with one small cultural practice per week.', feedbackAr: 'أطفالك قد يفتقدون مصدراً حيوياً للهوية والانتماء. ابدأ بممارسة ثقافية صغيرة واحدة في الأسبوع.' },
                { min: 4, max: 5, labelEn: 'Growing Roots', labelAr: 'جذور نامية', feedbackEn: 'You share some cultural elements. Consider making traditions more regular and involving children in choosing which ones to practice.', feedbackAr: 'أنت تشارك بعض العناصر الثقافية. فكر في جعل التقاليد أكثر انتظاماً وإشراك الأطفال في اختيار أيها يمارسون.' },
          ...
          likertReflections: [
            {
              ...
              scaleLabels: { lowEn: 'Rarely', lowAr: 'نادراً', highEn: 'Daily', highAr: 'يومياً' },
              interpretations: [
                { min: 1, max: 3, labelEn: 'Limited Emotional Language', labelAr: 'لغة عاطفية محدودة', feedbackEn: 'Start expanding your family\'s emotional vocabulary. Introducing words like "frustrated," "overwhelmed," and "proud" opens up richer conversations.', feedbackAr: 'ابدأ بتوسيع مفردات عائلتك العاطفية. تقديم كلمات مثل "محبط" و"مرهق" و"فخور" يفتح محادثات أغنى.' },
                { min: 4, max: 5, labelEn: 'Developing Literacy', labelAr: 'تطوير الوعي', feedbackEn: 'Your family is building emotional language. Try the emotion wall activity to make vocabulary building a daily practice.', feedbackAr: 'ابنِ' },
          ...
          likertReflections: [
            {
              ...
              scaleLabels: { lowEn: 'Very Difficult', lowAr: 'صعب جداً', highEn: 'Natural for Me', highAr: 'طبيعي بالنسبة لي' },
              interpretations: [
                { min: 1, max: 3, labelEn: 'Overwhelmed by Change', labelAr: 'مغمور بالتغيير', feedbackEn: 'Transitions take a toll on you too. Focus on keeping just one or two anchor routines and ask for support from your network.', feedbackAr: 'الانتقالات تؤثر عليك أيضاً. ركز على الحفاظ على روتين أو اثنين ثابتين واطلب الدعم من شبكتك.' },
                { min: 4, max: 5, labelEn: 'Building Stability', labelAr: 'بناء الاستقرار', feedbackEn: 'You manage some stability during change. Consider creating a Transition Anchor Plan to be more intentional about what stays constant.', feedbackAr: 'أنت تدير بعض الاستقرار خلال التغيير. فكر في إنشاء خطة مراسي انتقالية لتكون أكثر وعياً بما يبقى ثابتاً.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Repair Hesitant', labelAr: 'متردد في الإصلاح', feedbackEn: 'You may find apologizing to your child uncomfortable or unfamiliar. Start with one small repair this week. It gets easier with practice.', feedbackAr: 'الإصلاح' },
                { min: 4, max: 5, labelEn: 'Developing Repair Habit', labelAr: 'تطوير عادة الإصلاح', feedbackEn: 'You sometimes repair, which is already making a difference. Make it more consistent to normalize it in your family culture.', feedbackAr: 'الإصلاح' },
