          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Digital overload', labelAr: 'إفراط رقمي', feedbackEn: 'Start with one small change this week: establish one screen-free time (such as meals) for the whole family. Model the change yourself first.', feedbackAr: 'ابدأ بتغيير صغير واحد هذا الأسبوع: حدّد وقتاً واحداً خالياً من الشاشات (مثل الوجبات) لكل العائلة. كن أنت القدوة في التغيير أولاً.' },
                { min: 4, max: 6, labelEn: 'Room for improvement', labelAr: 'مساحة للتحسين', feedbackEn: 'You have some awareness. Try the Digital Wellness Check-In activity with your teen this week to identify specific areas for improvement together.', feedbackAr: 'لديك بعض الوعي. جرّب نشاط فحص العافية الرقمية مع ابنك المراهق هذا الأسبوع لتحديد مجالات محددة للتحسين معاً.' },
                { min: 7, max: 10, labelEn: 'Good digital balance', labelAr: 'توازن رقمي جيد', feedbackEn: 'Your family has a healthy foundation. Continue building digital literacy by discussing online experiences openly and staying curious about your teen\'s digital world.', feedbackAr: 'عائلتك لديها أساس صحي. استمر في بناء المعرفة الرقمية بمناقشة التجارب الإلكترونية بصراحة والبقاء فضولياً حول عالم ابنك المراهق الرقمي.' },
              ],
            },
          ],
          estimatedReadTimeMinutes: 5,
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Needs strengthening', labelAr: 'يحتاج تعزيزاً', feedbackEn: 'Focus on daily affirmations of who they are (not what they do). Try the Worth Inventory activity to begin building internal awareness of their value.', feedbackAr: 'ركّز على تأكيدات يومية عن من هم (وليس ما يفعلون). جرّب نشاط جرد تقدير الذات للبدء في بناء وعي داخلي بقيمتهم.' },
                { min: 4, max: 6, labelEn: 'Developing', labelAr: 'قيد التطور', feedbackEn: 'Your teen has some foundation. Help them identify and challenge comparison patterns, and consistently celebrate their character, effort, and kindness.', feedbackAr: 'ابنك المراهق لديه بعض الأساس. ساعده على تحديد أنماط المقارنة وتحدّيها واحتفِ باستمرار بشخصيته وجهده ولطفه.' },
                { min: 7, max: 10, labelEn: 'Strong foundation', labelAr: 'أساس قوي', feedbackEn: 'Your teen has solid self-worth. Continue modeling healthy self-worth yourself and encouraging meaningful contribution to sustain this foundation.', feedbackAr: 'ابنك المراهق لديه تقدير ذات متين. استمر في كونك قدوة في تقدير الذات الصحي وشجّع المساهمة الهادفة للحفاظ على هذا الأساس.' },
              ],
            },
          ],
          estimatedReadTimeMinutes: 5,
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Externally driven', labelAr: 'مدفوع خارجياً', feedbackEn: 'Your teen may be operating on compliance rather than passion. Try the Dream and Plan Session activity to discover what genuinely excites them beneath the surface expectations.', feedbackAr: 'قد يعمل ابنك المراهق بالامتثال بدلاً من الشغف. جرّب نشاط جلسة الحلم والتخطيط لاكتشاف ما يثيره حقاً تحت التوقعات السطحية.' },
                { min: 4, max: 6, labelEn: 'Mixed motivation', labelAr: 'تحفيز مختلط', feedbackEn: 'Your teen has some internal motivation. Look for ways to increase their autonomy and choices in how they pursue goals to strengthen intrinsic drive.', feedbackAr: 'لدى ابنك المراهق بعض الدافع الداخلي. ابحث عن طرق لزيادة استقلاليته وخياراته في كيفية سعيه نحو الأهداف لتقوية الدافع الذاتي.' },
                { min: 7, max: 10, labelEn: 'Intrinsically motivated', labelAr: 'محفّز داخلياً', feedbackEn: 'Your teen has strong internal motivation. Support their goals with practical help, accountability structures, and celebrations of effort and progress.', feedbackAr: 'لدى ابنك المراهق دافع داخلي قوي. ادعم أهدافه بمساعدة عملية وهياكل مساءلة واحتفالات بالجهد والتقدم.' },
              ],
            },
          ],
          estimatedReadTimeMinutes: 5,
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                { min: 1, max: 3, labelEn: 'Authority-centered', labelAr: 'مركّز على السلطة', feedbackEn: 'Shifting toward partnership is a process. Start by involving your teen in one family decision this week and genuinely considering their input.', feedbackAr: 'التحوّل نحو الشراكة عملية تدريجية. ابدأ بإشراك ابنك المراهق في قرار عائلي واحد هذا الأسبوع والنظر بجدية في مدخلاته.' },
                { min: 4, max: 6, labelEn: 'Evolving relationship', labelAr: 'علاقة متطورة', feedbackEn: 'You are making the transition. Try sharing one appropriate vulnerability with your teen this week and notice how it changes the dynamic.', feedbackAr: 'أنت في طور الانتقال. جرّب مشاركة لحظة ضعف مناسبة مع ابنك المراهق هذا الأسبوع ولاحظ كيف تغيّر الديناميكية.' },
                { min: 7, max: 10, labelEn: 'Strong partnership', labelAr: 'شراكة قوية', feedbackEn: 'You have built a collaborative relationship. Write the Partnership Letter and celebrate the journey you have taken together through this program.', feedbackAr: 'لقد بنيت علاقة تعاونية. اكتب رسالة الشراكة واحتفِ بالرحلة التي قطعتموها معاً عبر هذا البرنامج.' },
              ],
            },
          ],
          estimatedReadTimeMinutes: 5,
