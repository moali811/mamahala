          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 4, max: 5, labelEn: 'Building bridges', labelAr: 'بناء الجسور', feedbackEn: 'You have a foundation to work with. Practice leading with statements instead of questions and notice how your teen responds.', feedbackAr: 'لديك أساس للبناء عليه. تدرّب على البدء بعبارات بدلاً من أسئلة ولاحظ كيف يستجيب ابنك المراهق.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 4, max: 5, labelEn: 'Room for improvement', labelAr: 'مساحة للتحسين', feedbackEn: 'You have some awareness. Try the Digital Wellness Check-In activity with your teen this week to identify specific areas for improvement together.', feedbackAr: 'لديك بعض الوعي. جرّب نشاط فحص العافية الرقمية مع ابنك المراهق هذا الأسبوع لتحديد مجالات محددة للتحسين معاً.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 4, max: 5, labelEn: 'Building foundations', labelAr: 'بناء الأسس', feedbackEn: 'You have started the conversation. Try the Pressure Rehearsal activity to move from discussion to practical skill-building.', feedbackAr: 'لقد بدأت المحادثة. جرّب نشاط بروفة مواجهة الضغط للانتقال من النقاش إلى بناء المهارات العملية.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 4, max: 5, labelEn: 'Moderate pressure', labelAr: 'ضغط معتدل', feedbackEn: 'You are in a reasonable range. Try the Effort Conversation activity this week to shift any remaining outcome-focus toward process-focus.', feedbackAr: 'أنت في نطاق معقول. جرّب نشاط محادثة الجهد هذا الأسبوع لتحويل أي تركيز متبقٍّ على النتائج نحو التركيز على العملية.' },
          ...
          likertReflections: [
            {
              ...
              interpretations: [
                ...
                { min: 4, max: 5, labelEn: 'Developing', labelAr: 'قيد التطور', feedbackEn: 'Your teen has some foundation. Help them identify and challenge comparison patterns, and consistently celebrate their character, effort, and kindness.', feedbackAr: 'ابنك المراهق لديه بعض الأساس. ساعده على تحديد أنماط المقارنة وتحدّيها واحتفِ باستمرار بشخصيته وجهده ولطفه.' },
