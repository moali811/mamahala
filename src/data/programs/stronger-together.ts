          ...
          blocks: [
            {
              ...
              bodyAr: 'أَنْتَ غالِباً تُعْطي الحُبَّ بِلُغَتِكَ. شَريكُكَ غالِباً يَسْتَقْبِلُهُ بِلُغَةٍ أُخْرى. هذا الاِخْتِلافُ سَبَبُ شُعورِ الأَزْواجِ بِعَدَمِ الرُّؤْيَةِ رَغْمَ الحُبّ.\n\nمَرِّرْ على 5 لُغاتٍ + سِينَاريوهاتٍ لِعَلاقَتِكَ.',
            },
            {
            ...
            },
            {
              ...
              bodyAr: 'لِشُرَكاءَ لُغَةُ حُبِّهِم: "فَعَلْتَ ذلِكَ لَأْجلي."\n\nجَرِّبْ:\n• تَوَلَّ مَهَمَّةً يَكْرَهُها، دونَ طَلَب.\n• أَصْلِحْ شَيْئاً يُزْعِجُهُ مُنْذُ أَسابيع.\n• خُذْ نَوْبَةَ صَباحِ الأَوْلادِ لِيَنامَ هو.',
            },
            {
            ...
            },
            {
              ...
              bodyAr: 'اللَّيْلَة، اِسْأَلْ شَريكَكَ: "مَتى تَشْعُرُ أَنَّكَ مَحْبوبٌ مِنّي أَكْثَر؟" لا تُدافِعْ. اِسْتَمِعْ.\n\nجَوابُهُ هو اللُّغَة. الآنَ تَكَلَّمْ بِها بِقَصْد — كُلَّ أُسْبوع، لِلأَبَد.',
            },
          ],
          frameworkDiagrams: [
            {
          ...
          blocks: [
            ...
            },
            {
              ...
              question: {
                ...
                textAr: 'شَريكُكَ يَتَذَمَّرُ عَنْ شَيْءٍ في العَمَل. يَتَوَقَّفُ في مُنْتَصَفِ الجُمْلَة. ما أَفْضَلُ خُطْوَةٍ تالِيَة؟',
                options: [
                  { labelEn: 'Jump in with advice — they\'re looking for solutions', labelAr: 'اِقْفِزْ بِنَصيحَة — إنَّهُ يَطْلُبُ حَلاً', correct: false, explanationEn: 'Most venting isn\'t solution-seeking. It\'s seeking to be heard.', explanationAr: 'مُعْظَمُ التَّذَمُّرِ لا يَطْلُبُ حَلاً. يَطْلُبُ الاِسْتِماع.' },
                  { labelEn: 'Silence + eye contact — let them finish the thought', labelAr: 'صَمْت + تَواصُلٌ بَصَرِيّ — دَعْهُ يُنْهي الفِكْرَة', correct: true, explanationEn: 'Yes. The pause is often the MIDDLE, not the end.', explanationAr: 'نَعَم. الوَقْفَةُ غالِباً هي المُنْتَصَف، لَيْسَ النِّهايَة.' },
                  { labelEn: 'Share your similar story', labelAr: 'شارِكْ قِصَّتَكَ المُماثِلَة', correct: false, explanationEn: 'Makes it about you. Stay on THEIR moment.', explanationAr: 'تَجْعَلُها عَنْكَ. اِبْقَ عَلى لَحْظَتِه.' },
                ],
              },
            },
            {
            ...
            },
            {
              ...
              promptAr: 'مَتى آخِرَ مَرَّةٍ غادَرَ شَريكُكَ مُحادَثَةً شاعِراً بِالسَّماعِ حَقّاً؟ ما الّذي جَعَلَها آمِنَةً لَه؟',
            },
          ],
        },
        {
...
الخلاف، عندما يُعالَج بعناية، يعمّق الألفة في الواقع. يُظهر لكلا الشريكين أن العلاقة قوية بما يكفي لتحمل الحقائق الصعبة وأن الحب لا يتطلب الكمال — بل يتطلب الصدق والجهد.`,
          ...
          blocks: [
            ...
            },
            {
              ...
              choices: [
                ...
                },
                {
                  ...
                  feedbackAr: 'الإغْراقُ حَقيقيّ. أَحْياناً المَساحَةُ صَحيحَة. لَكِنْ سَمِّها: "أَحْتاجُ 15 دَقيقَةً لِأَهْدَأ."',
                  isRecommended: false,
                },
              ],
            },
            ...
            },
            {
              ...
              textAr: 'وَجَدَ جوتْمان: 69% من خِلافاتِ الأَزْواجِ دائِمَة (لا تُحَلُّ كامِلاً). الأَزْواجُ المُزْدَهِرونَ لا يَحُلّونَها — يُلَيِّنونَها، بِتَكْرار، بِلَحَظاتِ إصْلاحٍ صَغيرَة. كُلُّ شِجارٍ فُرْصَةٌ لِتَكونَ الشَّخْصَ الّذي تُريدُ الزَّواجَ مِنْه.',
            },
            {
            ...
            },
            {
              ...
              textAr: 'الأَزْواجُ الّذينَ يَدومونَ لَيْسوا الّذينَ يَتَشاجَرونَ أَقَلّ. الّذينَ يُصْلِحونَ أَسْرَع. كُلُّ بِدايَةٍ قاسِيَةٍ لَها فُرْصَةٌ جَديدَة. كُلُّ لَحْظَةٍ دِفاعيَّةٍ يُمْكِنُها أَنْ تَصيرَ اعْتِذاراً. هذِهِ المَهارَة. قابِلَةٌ لِلتَّعَلُّم. فَعَلْتَها للتَّوّ — هُنا، تُشاهِدُ هذِهِ القِصَّة.',
            },
            {
              ...
              promptAr: 'مَتى آخِرَ بِدايَةٍ قاسِيَةٍ لَكَ؟ كَيْفَ سَتَبْدو "فُرْصَةٌ جَديدَة"؟ هل يُمْكِنُكَ اسْتِدْعاؤُها اللَّيْلَة؟',
            },
          ],
          frameworkDiagrams: [
            {
...
المهارة الأكثر تحولاً التي يمكنكما تطويرها كزوجين ليست تعلم خوض خلافات أقل أو مواعيد رومانسية أكثر — بل هي تعلم رؤية والاستجابة لمئات العروض الصغيرة التي يقدمها شريككما كل يوم. في كل مرة تتوجه نحو عرض، أنت تعزز أساس حبكما. في كل مرة، أنت تقول: "أراك. أنت مهم بالنسبة لي. نحن في هذا معًا."`,
          ...
          blocks: [
            ...
            },
            {
              ...
              textAr: 'هذا التَّقْييمُ يُحَدِّدُ نَمَطَ نِداءاتِكَ. أَجِبْ بِصِدْق — الهَدَفُ وَعْيٌ، لا عار. كُلُّ الأَزْواجِ يُفَوِّتونَ نِداءات. الأَفْضَلُ يُلاحِظونَ ويَعودون.',
            },
            {
              ...
              reflection: {
                ...
                interpretations: [
                  { min: 1, max: 2, labelEn: 'Distracted awareness', labelAr: 'وَعْيٌ مُشَتَّت', feedbackEn: 'Phones, kids, exhaustion — they compete with your partner\'s bids. Try one thing: put your phone face-down when they enter the room.', feedbackAr: 'الهَواتِف، الأَوْلاد، الإرْهاق — تُنافِسُ نِداءاتِه. جَرِّبْ شَيْئاً: ضَعْ هاتِفَكَ مَقْلوباً حينَ يَدْخُل.' },
                  { min: 3, max: 5, labelEn: 'Mixed tracking', labelAr: 'تَتَبُّعٌ مُخْتَلِط', feedbackEn: 'You catch some, miss some. Awareness alone will move this up — keep noticing.', feedbackAr: 'تَلْتَقِطُ بَعْضاً وتُفَوِّتُ بَعْضاً. الوَعْيُ وَحْدَهُ سَيَرْفَعُها — واصِلْ المُلاحَظَة.' },
                  { min: 6, max: 7, labelEn: 'Attuned', labelAr: 'مُتَناغِم', feedbackEn: 'You\'re seeing the bids. Keep turning toward them, not just noticing.', feedbackAr: 'تَرى النِّداءات. واصِلْ التَّوَجُّهَ نَحْوَها، لَيْسَ فَقَطْ المُلاحَظَة.' },
                ],
              },
            },
            {
              ...
              reflection: {
                ...
                interpretations: [
                  { min: 1, max: 2, labelEn: 'Turning away', labelAr: 'تَتَوَجَّهُ بَعيداً', feedbackEn: 'This is where marriages erode quietly. Try: a simple "mm-hm" or eye contact when they speak — that counts.', feedbackAr: 'هُنا تَتَآكَلُ الزِّيجاتُ بِهُدوء. جَرِّبْ: "مممم" أَوْ تَواصُلاً بَصَرِيّاً حينَ يَتَكَلَّم — هذا يَحْسَب.' },
                  { min: 3, max: 5, labelEn: 'Inconsistent', labelAr: 'غَيْرُ ثابِت', feedbackEn: 'Practice micro-responses. Every acknowledgment is a deposit.', feedbackAr: 'مارِسْ اسْتِجاباتٍ صَغيرَة. كُلُّ اعْتِرافٍ إيداع.' },
                  { min: 6, max: 7, labelEn: 'Responsive', labelAr: 'مُسْتَجيب', feedbackEn: 'This is the foundation. Keep depositing.', feedbackAr: 'هذا الأَساس. واصِلْ الإيداع.' },
                ],
              },
            },
            {
              ...
              reflection: {
                ...
                statementAr: 'حينَ يَصْنَعُ شَريكي نِداءً وأَنا مُنْزَعِج، لا أَنْفَعِلُ عَلَيْهِ لِلتَّواصُل.',
                scaleLabels: { lowEn: 'Snap often', lowAr: 'أَنْفَعِلُ كَثيراً', highEn: 'Stay kind', highAr: 'أَبْقى لَطيفاً' },
                interpretations: [
                  { min: 1, max: 2, labelEn: 'Turning against', labelAr: 'تَوَجُّهٌ ضِدّ', feedbackEn: 'This is the most destructive pattern. When you can\'t turn toward, at least go neutral: "I need a minute" instead of snapping.', feedbackAr: 'هذا أَخْطَرُ الأَنْماط. حينَ لا تَسْتَطيعُ التَّوَجُّهَ نَحْوَ، كُنْ مُحايِداً: "أَحْتاجُ دَقيقَةً" بَدَلاً من الاِنْفِعال.' },
                  { min: 3, max: 5, labelEn: 'Sometimes sharp', labelAr: 'حادٌّ أَحْياناً', feedbackEn: 'Awareness is already shifting this. Notice the cue — your body before your mouth.', feedbackAr: 'الوَعْيُ يُحَرِّكُ هذا. لاحِظْ الإشارَة — جَسَدَكَ قَبْلَ فَمِكَ.' },
                  { min: 6, max: 7, labelEn: 'Kind under stress', labelAr: 'لَطيفٌ تَحْتَ الضَّغْط', feedbackEn: 'Rare and precious. Your partner feels safe even when you\'re stressed.', feedbackAr: 'نادِرٌ وثَمين. شَريكُكَ يَشْعُرُ بِالأَمانِ حَتّى وأَنْتَ مُرْهَق.' },
                ],
              },
            },
            {
              ...
              reflection: {
                ...
                interpretations: [
                  { min: 1, max: 2, labelEn: 'Stopped initiating', labelAr: 'تَوَقَّفْتَ عَنِ المُبادَرَة', feedbackEn: 'Maybe past rejections made you stop. Worth exploring: what did it cost you to stop?', feedbackAr: 'رُبَّما رَفَضاتٌ سابِقَةٌ أَوْقَفَتْكَ. تَسْتَحِقُّ الاِسْتِكْشاف: ماذا كَلَّفَكَ التَّوَقُّف؟' },
                  { min: 3, max: 5, labelEn: 'Cautious bidding', labelAr: 'نِداءاتٌ حَذِرَة', feedbackEn: 'Safety is forming. Risk one extra bid this week.', feedbackAr: 'الأَمانُ يَتَشَكَّل. خاطِرْ بِنِداءٍ إضافِيٍّ هذا الأُسْبوع.' },
                  { min: 6, max: 7, labelEn: 'Bidding freely', labelAr: 'نِداءاتٌ حُرَّة', feedbackEn: 'This is what intimate safety looks like. Keep going.', feedbackAr: 'هذا ما يَبْدو عَلَيْهِ الأَمانُ الحَميميّ. واصِلْ.' },
                ],
              },
            },
            {
              ...
              textAr: 'اُنْظُرْ لِأَقَلِّ دَرَجَة. هُناكَ تَتَسَرَّبُ عَلاقَتُكَ. الخَبَرُ الجَيِّد: كُلُّ اسْتِجابَةٍ قابِلَةٌ لِلعَكْس. ابْتِداءً من اليَوْم، 10 لَحَظاتِ "تَوَجُّهٍ نَحْوَ" إضافيَّةٍ يَوْميّاً تَقْلِبُ النَّمَطَ في شَهْر.',
            },
            {
              ...
              promptAr: 'أَيْنَ كانَتْ أَقَلَّ دَرَجَة؟ ما نِداءٌ مُحَدَّدٌ فَوَّتَّهُ مُؤَخَّراً؟ كَيْفَ سَيَبْدو التَّوَجُّهُ نَحْوَه؟',
            },
          ],
          frameworkDiagrams: [
            {
...
القبول هو حجر الزاوية في التعامل مع الاختلافات. هذا لا يعني الاستسلام لعدم السعادة. بل يعني اختيار حب شريكك بالكامل — بما في ذلك الأجزاء المختلفة عنك — بدلاً من حب نسخة مثالية تتمنى أن يصبحها. والمفارقة أنه عندما يشعر الناس بالقبول كما هم، غالبًا ما يصبحون أكثر استعدادًا للتمدد والنمو.`,
          ...
          format: 'standard',
          blocks: [
            { kind: 'paragraph', id: 'nd-lead', tone: 'lead', textEn: 'You and your partner will never fully agree. That\'s not a problem to solve — it\'s a feature of two separate people choosing each other. The skill is HOW you hold those differences without them corroding the love.', textAr: 'أَنْتَ وشَريكُكَ لَنْ تَتَّفِقا كامِلاً أَبَداً. هذا لَيْسَ مُشْكِلَةً — إنَّها مَيزَةُ شَخْصَيْنِ مُنْفَصِلَيْنِ يَخْتارانِ بَعْضَهُما. المَهارَةُ في كَيْفَ تَحْمِلُ الاِخْتِلافاتِ بِلا أَنْ تَأْكُلَ الحُبّ.' },
            ...
            },
            {
              ...
              question: {
                ...
                options: [
                  { labelEn: 'Get them to see your way', labelAr: 'اِجْعَلْهُ يَرى طَريقَتَكَ', correct: false, explanationEn: 'Conversion rarely works.', explanationAr: 'التَّحْويلُ نادِراً ما يَنْجَح.' },
            ...
            { kind: 'callout', id: 'nd-drhala', variant: 'dr-hala', textEn: 'Every unresolved difference is an invitation to know your partner more deeply. Take the invitation.', textAr: 'كُلُّ اخْتِلافٍ غَيْرِ مَحْلولٍ دَعْوَةٌ لِمَعْرِفَةِ شَريكِكَ أَعْمَق. اِقْبَلْ الدَّعْوَة.' },
...
يمكن للتوقعات الثقافية أيضًا أن تشكّل أنماط الألفة. في بعض التقاليد، لا يُقدَّم الانفتاح العاطفي بين الزوجين كنموذج، مما يجعله أرضًا غير مألوفة. اعلما أن بناء أنماط ألفة جديدة هو عملية تعلم مشتركة، وامنحا الصبر والتشجيع لأنفسكما ولبعضكما البعض أثناء نموكما.`,
          ...
          blocks: [
            ...
            { kind: 'reflection-prompt', id: 'ib-refl', minWords: 40, promptEn: 'Which layer is strongest in your relationship? Which is starved? What\'s one small thing you\'d do THIS week to feed the starved one?', promptAr: 'أَيُّ طَبَقَةٍ الأَقْوى؟ أَيُّها جائِعَة؟ شَيْءٌ صَغيرٌ تَفْعَلُهُ هذا الأُسْبوع؟' },
          ],
          frameworkDiagrams: [
            {
              type: 'iceberg',
...
عندما تنشأ خلافات حول التربية — وستنشأ — عودا إلى مهارات التواصل من الوحدات السابقة: استمعا بفضول، حددا القيمة الأعمق وراء كل موقف، وابحثا عن حلول تحترم كلا المنظورين. تذكرا أنكما في نفس الفريق، والهدف هو رفاهية طفلكما وقوة عائلتكما.`,
          ...
          format: 'challenge',
          blocks: [
            { kind: 'paragraph', id: 'cp-lead', tone: 'lead', textEn: 'Your kids don\'t need a united front on EVERY decision. They need parents who coordinate on the big things, disagree respectfully about the small things, and never use them as weapons against each other.', textAr: 'أَطْفالُكُم لا يَحْتاجونَ جَبْهَةً مُوَحَّدَةً في كُلِّ قَرار. يَحْتاجونَ والِدَيْنِ يُنَسِّقانِ في الكَبير، ويَخْتَلِفانِ بِاحْتِرامٍ في الصَّغير، ولا يَسْتَخْدِمانِهِم سِلاحاً ضِدَّ بَعْضِهِما.' },
            ...
            { kind: 'challenge-step', id: 'cp-d3', dayLabel: 3, titleEn: 'Publicly Back Your Partner', titleAr: 'اِدْعَمْ شَريكَكَ عَلَناً', instructionEn: 'Today, in front of kids, explicitly back your partner\'s decision — even if you disagreed privately. "Mom decided. That\'s the answer. If you want to revisit it, come to BOTH of us together."', instructionAr: 'اليَوْم، أَمامَ الأَوْلاد، اِدْعَمْ قَرارَ شَريكِكَ صَراحَةً — حَتّى لَوِ اخْتَلَفْتَ. "ماما قَرَّرَتْ. هذا الجَواب. إذا أَرَدْتَ إعادَةَ النَّظَر، تَعالَ لِكِلَيْنا مَعاً."', checkInPromptEn: 'Did you back them publicly? How did the kids respond?', checkInPromptAr: 'هل دَعَمْتَهُ أَمامَ الأَوْلاد؟ كَيْفَ تَفاعَلوا؟' },
            { kind: 'challenge-step', id: 'cp-d4', dayLabel: 4, titleEn: 'Disagree Privately', titleAr: 'اِخْتَلِفا عَلى انْفِراد', instructionEn: 'Tonight, after kids are asleep, raise ONE parenting disagreement you\'ve been swallowing. Not attack. Just: "I\'ve been wanting to talk about how we handle ___."', instructionAr: 'اللَّيْلَة، بَعْدَ نَوْمِ الأَوْلاد، اِرْفَعْ خِلافاً تَرْبَوِيّاً تَبْتَلِعُه. لا هُجوم. فَقَط: "كُنْتُ أُريدُ الحَديثَ حَوْلَ كَيْفَ نَتَعامَلُ مع ___."', checkInPromptEn: 'What did you raise? How did they respond?', checkInPromptAr: 'ماذا رَفَعْتَ؟ كَيْفَ اسْتَجاب؟' },
            { kind: 'challenge-step', id: 'cp-d5', dayLabel: 5, titleEn: 'Appreciate One Strength', titleAr: 'قَدِّرْ قُوَّةً واحِدَة', instructionEn: 'Tell your partner ONE specific thing they do well as a parent. Specific. Detailed. Not generic. Watch what happens.', instructionAr: 'أَخْبِرْ شَريكَكَ شَيْئاً واحِداً يَفْعَلُهُ جَيِّداً كَوالِد. مُحَدَّد. مُفَصَّل. لَيْسَ عامّاً. راقِبْ ما يَحْدُث.', checkInPromptEn: 'What did you say? How did they receive it?', checkInPromptAr: 'ماذا قُلْتَ؟ كَيْفَ اسْتَقْبَلَها؟' },
            { kind: 'challenge-step', id: 'cp-d6', dayLabel: 6, titleEn: 'Ask for What You Need', titleAr: 'اِطْلُبْ ما تَحْتاج', instructionEn: 'Name ONE thing you need more of from your co-parent. Specific ask. "Can you be the one to handle bedtimes this week so I can decompress?"', instructionAr: 'سَمِّ شَيْئاً واحِداً تَحْتاجُهُ من شَريكِكَ. طَلَبٌ مُحَدَّد. "هل تَتَوَلّى وَقْتَ النَّوْمِ هذا الأُسْبوعَ لِأَرْتاح؟"', checkInPromptEn: 'What did you ask for? Did they say yes?', checkInPromptAr: 'ماذا طَلَبْتَ؟ هل وافَق؟' },
            ...
            { kind: 'callout', id: 'cp-drhala', variant: 'dr-hala', textEn: 'Your children don\'t learn marriage from what you tell them. They learn it from watching you and your partner resolve disagreements — or refuse to. Co-parenting IS modeling the relationship skills they\'ll use all their lives.', textAr: 'أَطْفالُكُم لا يَتَعَلَّمونَ الزَّواجَ من ما تُخْبِرونَهُم. يَتَعَلَّمونَهُ من مُشاهَدَتِكُما تَحُلّانِ الاِخْتِلافات — أَوْ تَرْفُضان. التَّرْبيَةُ المُشْتَرَكَةُ هي تَعْليمُ مَهاراتِ العَلاقَةِ الّتي سَيَسْتَخْدِمونَها حَياتَهُم.' },
          ],
        },
      ],
    },
            ...
            { kind: 'story-choice', id: 'rt-c2', promptEn: 'What does HE do here?', promptAr: 'ماذا يَفْعَلُ هو هُنا؟', choices: [ { labelEn: 'Reassure quickly: "Your perception was right. I was wrong."', labelAr: 'يُطَمْئِنُها بِسُرْعَة: "حَدْسُكِ كانَ صَحيحاً. أَنا الخَطَأ."', feedbackEn: 'Too fast. She needs to sit IN the questioning, not be rushed out of it.', feedbackAr: 'سَريعٌ جِدّاً. تَحْتاجُ الجُلوسَ في الشَّكّ، لا الخُروجَ مِنْهُ بِاسْتِعْجال.', isRecommended: false }, { labelEn: 'Sit in the discomfort: "I hear you. I took that from you. That\'s one of the hardest things I\'ve done, and I didn\'t even know I was doing it."', labelAr: 'يَجْلِسُ في الاِضْطِراب: "أَسْمَعُكِ. أَخَذْتُ ذلِكَ مِنْكِ. هذا من أَصْعَبِ ما فَعَلْتُ، ولَمْ أَكُنْ حَتّى أَعْرِفُ أَنَّني أَفْعَلُه."', feedbackEn: 'This is the accountability that rebuilds. He stays WITH her pain without rushing to solve it.', feedbackAr: 'هذِهِ المَسْؤوليَّةُ الّتي تُعيدُ البِناء. يَبْقى مَعَ أَلَمِها بِلا اسْتِعْجالِ حَلّ.', isRecommended: true } ] },
            {
              ...
              diagram: {
                ...
                nodes: [
                  ...
                  { id: 'accountability', labelEn: 'Accountability', labelAr: 'مَسْؤوليَّة', descriptionEn: 'Explain why, without excuses. Own the pattern, not just the incident', descriptionAr: 'اِشْرَحْ لِماذا، بِلا أَعْذار. اِمْتَلِكْ النَّمَط، لا الحادِثَةَ فَقَط', insightEn: 'Look for the pattern underneath the incident. "I tend to shut down when I feel criticized" shows deeper self-awareness than just apologizing for one event.', insightAr: 'اِبْحَثْ عَنِ النَّمَطِ تَحْتَ الحادِثَة. "أَميلُ لِلاِنْغِلاقِ عِنْدَما أَشْعُرُ بِالنَّقْد" يُظْهِرُ وَعْياً ذاتيّاً أَعْمَقَ مِنْ مُجَرَّدِ الاِعْتِذارِ عَنْ حَدَثٍ واحِد.', color: '#D4A84B', position: { x: 50, y: 25 } },
